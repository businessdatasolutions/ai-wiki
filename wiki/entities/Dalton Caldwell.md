...
type: entity
kind: person
aliases: ["Dalton Caldwell", "Dalton"]
tags: [dalton-caldwell, y-combinator, yc-group-partner, founder-firesides-host, founder-coaching, tar-pit-ideas, pivots, request-for-startups, evergreen-yc-wisdom, mixed-media-labs, app-net, picplz]
...
1. **First substantive source mention** — [[2026-05-20-glasgow-campfire-erp-for-ai-revolution|Glasgow / Campfire (20 May 2026)]] where Caldwell is named as Campfire's *YC partner of record* + as the original author of YC's *ERPs as a request-for-startups category* prompt that Campfire emerged in response to. *Dangling-list mention only at first ingest.*
2. **Second substantive source mention (this promotion)** — [[2024-04-18-caldwell-lennys-podcast-lessons-1000-yc-startups-tarpit-ideas|Caldwell / Lenny's Podcast (18 April 2024)]] — the wiki's first solo-headlining Caldwell ingest, the canonical articulation of his pivot doctrine + tar-pit-ideas vocabulary + customer-validation-first prescription + the 2024 request-for-startups inventory.
...
The wiki's **AI-native-ERP-vendor cluster** ([[2026-05-20-glasgow-campfire-erp-for-ai-revolution|Glasgow / Campfire]], [[2026-05-11-hill-vori-grocery-os-paper-and-fax|Hill / Vori]], [[2026-04-09-dinakaran-yc-luminai-automating-americas-biggest-hospitals|Dinakaran / Luminai]]) is the AI-substrate-era instantiation of the same pivot template — each company applies Caldwell's *find-a-large-incumbent-with-low-NPS* prompt to a different vertical (finance-ops / grocery-ops / healthcare-admin) and uses AI as the wedge.
...
The *Winter 17 batch and the brex story* anecdote (~12:08–14:00) — paired with Danny Alberon's question *"what is wrong with our batch — everyone is struggling, nobody is doing well — what have we done wrong?"* — gives the empirical-base anchor that [[2026-05-19-mittal-yhangry-private-chef-all-in-on-ai-agents|Mittal / Yhangry]]'s *"I probably need to kill my human empathy a little bit more, a little bit faster"* (May 2026, AI-native-rebuild altitude) gestures at from inside the founder-vantage.
...
Operationalised at the AI-substrate-era enterprise-altitude by [[2026-04-09-dinakaran-yc-luminai-automating-americas-biggest-hospitals|Dinakaran / Luminai]] as the LinkedIn-contact-scraping + warm-intro discipline + red-eye cadence + *you're selling a champion within the institution, not the institution* framing.
