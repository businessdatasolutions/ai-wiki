...
relationships:
  - type: part-of
    ...
    via: "Editorial Director; host of The McKinsey Podcast"
---
...
- Anchors questions in specific reported numbers (e.g. the $125M→$77M break-even cost shift) and asks the interviewee to explain the driving mechanism.
- Uses concrete framing devices to surface counterarguments (e.g. explicitly voicing the skeptical leader's "it's just not the right time" objection) rather than only asking open-ended questions.
- Closes on a personal/reflective note (asks Bello which of his built businesses he's most proud of) — a consistent McKinsey Podcast structural beat.
