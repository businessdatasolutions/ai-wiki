...
type: entity
kind: organization
aliases: ["DeepLearningAI", "DeepLearning.AI", "deeplearning.ai", "DLAI"]
...
relationships:
  ...
  - type: published-by
    ...
    via: "Andrew Ng's AI Dev 26 x SF keynote — the future-of-software-engineering address with Context Hub + Code Dream/Code Realm announcements (20 May 2026)"
  - type: published-by
    target: 2026-05-22-khan-cline-deeplearningai-ai-dev-26-sf-evals-are-broken-use-them-anyway
    via: "Ara Khan's AI Dev 26 x SF practitioner-track session on Cline's eval-discipline programme (22 May 2026)"
---
...
1. **First source** — [[2026-05-20-ng-deeplearningai-ai-dev-26-sf-future-of-software-engineering|Ng / AI Dev 26 x SF (20 May 2026)]] — Andrew Ng's own keynote at the conference DeepLearningAI runs; the *future-of-software-engineering* address with PM-bottleneck thesis + cascading bottlenecks + AI-job-apocalypse counter-claim + Context Hub + Code Dream / Code Realm product announcements.
2. **Second source (this promotion)** — [[2026-05-22-khan-cline-deeplearningai-ai-dev-26-sf-evals-are-broken-use-them-anyway|Khan / Cline / AI Dev 26 x SF (22 May 2026)]] — Ara Khan's practitioner-track session at the same conference, two days later. The customer-of-model-vendor altitude on eval discipline; Cline beats Claude Code on Opus 4.5 evals via harness optimisation.

## Role in the wiki

DeepLearningAI is the **AI-conference-and-AI-education-platform vantage** the wiki tracks across the 2025–2026 AI-buildout corpus. Where [[Y Combinator]] / *YC Root Access* operates as the *startup-batch-context* channel-entity, [[Lenny's Podcast]] as the *practitioner-interview* channel-entity, and the [[Anthropic|Claude]] YouTube channel as the *model-vendor-customer-stories* channel-entity, **DeepLearningAI sits as the *educator-and-conference-organiser* channel-entity** — combining Ng's personal AI-leader keynote vantage with practitioner-track sessions from the broader 2026 AI-engineering community.
...
|---|---|---|---|
| [[2026-05-20-ng-deeplearningai-ai-dev-26-sf-future-of-software-engineering\|Ng / AI Dev 26]] | [[Andrew Ng]] | AI-leader / educator | PM-bottleneck thesis + cascading bottlenecks + 100%-AI-coding norm + AI-job-apocalypse counter-claim + Context Hub + Code Dream announcements |
| [[2026-05-22-anthropic-evals-for-taste-hill-climbing-slide-generation-agent\|Anthropic / Claude channel]] | Unidentified Anthropic-side presenter | Model-vendor practitioner-engineer | Grader-type taxonomy + QA-loop adversarial pattern + autoregressive-judge-ordering bug + slide-gen agent worked example |
| [[2026-05-22-khan-cline-deeplearningai-ai-dev-26-sf-evals-are-broken-use-them-anyway\|Khan / AI Dev 26]] | Ara Khan (Cline) | Customer-of-model-vendor / coding-agent vendor | Two-camps framing + three heuristics + Cline's terminal-bench journey + three-zones-of-improvement + Cline-beats-Claude-Code on Opus 4.5 |
