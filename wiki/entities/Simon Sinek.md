...
kind: person
aliases: ["Simon Sinek"]
tags: [simon-sinek, leadership, infinite-game, start-with-why, a-bit-of-optimism, optimist, author, podcast-host]
confidence: 0.75
...
LIST
FROM "wiki/sources"
WHERE contains(file.outlinks, this.file.link) OR contains(tags, "simon-sinek")
SORT file.name ASC
```
