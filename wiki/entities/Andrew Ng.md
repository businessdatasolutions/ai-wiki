...
type: entity
kind: person
aliases: ["Andrew Ng", "Andrew Y. Ng", "@andrewyng"]
...
1. **First substantive mention** — [[2026-03-31-carrier-mit-industrial-ai-that-works-strategy-survival-success|Carrier / MIT March 2026]] cross-reference via the *"we need to unbig in AI"* quote: *"A word from Andrew Ng, who's a Stanford professor. Even he, after ten years, has said we need to unbig in AI."* — naming Ng as the canonical *Stanford-academic-altitude voice* on the unbigging-of-AI thesis at the industrial-AI altitude.
...
The wiki's **strongest unconditional 100%-AI-coding claim** at a conference altitude. Productive tension with [[2026-03-23-wu-an-yc-momentic-qa-layer-ai-coding-era|Wu / Momentic]]'s *"Codex only makes you a 10× engineer if you weren't a 10× engineer to begin with"* (conditional-on-baseline); structural convergence with [[2026-05-20-tan-hu-stanford-cs153-ai-native-company-1000x-engineer|Tan & Hu / CS153]]'s unconditional *1,000× engineer* framing.
...
The twin of [[2026-05-21-jones-stanford-gsb-ai-and-our-economic-future|Chad Jones / Stanford GSB]]'s academic-economist-vantage on the same question — Jones provides the *theoretical mechanism* (weak-links / jobs-as-bundles-of-tasks); Ng provides the *empirical headcount observation from inside hiring*.

### 5. The AI-engineer hiring rubric

The three-criterion checklist Ng's teams use:

1. **Ability to use coding agents effectively** — Claude Code, Gemini, Codex, Open Code, or others.
2. **Robust knowledge of the proliferating building blocks** — *"a challenge because there's so many of them. So many and they change so quickly."*
3. **Generalist skills** — basic product management, or other functional skills outside narrow engineering.
...
Ng's prior wiki-relevant rhetorical contribution: *"we need to unbig in AI"* — the academic-altitude counter-thesis to the *bigger-models-only* narrative. Used by [[2026-03-31-carrier-mit-industrial-ai-that-works-strategy-survival-success|Carrier / MIT]] as the canonical *fit-for-purpose-beats-generality* anchor for the industrial-AI altitude. The continuity to the May 2026 *future-of-software-engineering* talk: *building blocks proliferate* + *small-purpose-fit-models-and-skills-mix-and-match* + *combinatorial composition* is the same *unbig-then-recombine* thesis at the building-blocks-altitude rather than the model-altitude.
