...
Hu's load-bearing structural-systems claim, articulated cleanly in [[2026-05-20-tan-hu-stanford-cs153-ai-native-company-1000x-engineer|CS153 2026]]:
...
1. **IC (individual contributor)** — *everyone* ships, including non-technical staff. A salesperson builds their own pipeline of calls and meetings; even non-technical employees use AI tools to build something.
2. **DRI (direct responsible individual)** — orchestrates ICs toward an outcome; *"tends to oftentimes be the founder."* Hu cites Apple's *DRI* (Direct Responsible Individual) tradition by name.
...
The benchmark is presented across both Hu sources without disclosure of the underlying ranges; the cohort-claim is anchored to YC portfolio companies. Independent ratification in the wiki: [[2026-05-19-garg-yc-internal-ai-agent-evolves-itself|Garg / AnswerThis 2026]] reports $2M ARR with two full-time employees + 2–3 contractors (~$400k–$1M per FTE-equivalent depending on how contractors count); [[2026-05-13-jha-emergent-democratizing-app-building-with-claude|Jha / Emergent 2026]] reports $100M ARR in 8 months with a small founding team (precise headcount not stated in the wiki anchor).

### 4. The forward-deployed-engineer wedge

Hu's CS153 close ([[2026-05-20-tan-hu-stanford-cs153-ai-native-company-1000x-engineer|CS153 2026]]) names three YC portfolio companies as the wedge-strategy worked examples — *"these are companies that done this crazy growth that I'm telling you that gone zero to eight figures in revenue within a year"*:
...
Hu's CS153 articulation echoes [[Andrej Karpathy]]'s [[concepts/agentic-engineering|agentic-engineering]] paired-construct ([[2026-04-29-andrej-karpathy-from-vibe-coding-to-agentic-engineering|Karpathy 2026]]) and aligns with the [[concepts/durable-skills|durable-skills]] thesis the wiki carries. Hu's operational corollary: taste manifests at *the eval design* — *"generic benchmarks won't make it; whether your product works MMLU doesn't tell you. The judge ultimately of whether something is good is whether users really want it."*
...
| Source | Connection |
|---|---|
| [[2026-04-24-hu-yc-how-to-build-a-company-with-ai-from-the-ground-up\|Hu / YC April 2026]] | First-party-CEO-altitude-but-via-partner-voice prescription on AI-native company construction. |
| [[2026-05-20-tan-hu-stanford-cs153-ai-native-company-1000x-engineer\|Tan & Hu / Stanford CS153 2026]] | Re-anchors April framing at Stanford-classroom altitude; adds control-systems closed-loop framing, Jack Dorsey reference, and the Salient/Happy Robot/Reducto forward-deploy wedge examples. |
| [[2026-04-23-tan-yc-how-to-make-claude-code-your-ai-engineering-team-gstack\|Tan / GStack 2026]] | The paired [[Garry Tan]] talk one day earlier. Tan is the worked example of Hu's *AI founder type* prescription. |
| [[2026-05-13-jha-emergent-democratizing-app-building-with-claude\|Jha / Emergent 2026]] | Portfolio-founder worked example of Hu's $1–2M revenue-per-employee benchmark at the platform-vendor scale. |
| [[2026-05-19-garg-yc-internal-ai-agent-evolves-itself\|Garg / AnswerThis 2026]] | Portfolio-founder worked example at the 2-FTE-startup scale; $2M ARR with two FTEs is an independent ratification of Hu's revenue-per-employee benchmark. |
| [[2026-04-29-andrej-karpathy-from-vibe-coding-to-agentic-engineering\|Karpathy 2026]] | Hu's *taste-as-the-durable-thing* echoes Karpathy's [[concepts/agentic-engineering\|agentic-engineering]] paired-construct (vibe coding raises the floor, agentic engineering preserves the ceiling). |
...
LIST
FROM "wiki/sources"
WHERE contains(file.outlinks, this.file.link) OR contains(tags, "diana-hu") OR contains(tags, "ai-native-company")
SORT file.name ASC
```
