...
type: entity
kind: person
aliases: ["Daron Acemoglu", "Duron Oamoglu"]
tags: [daron-acemoglu, economist, nobel-economics-2024, mit, productivity-is-five-things, ai-productivity-paradox, institutions-economic-growth]
...
LIST
FROM "wiki/sources"
WHERE contains(file.outlinks, this.file.link) OR contains(tags, "daron-acemoglu")
SORT file.name ASC
```
