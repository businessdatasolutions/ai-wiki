...
type: entity
kind: person
aliases: ["Lisa Krayer", "L. Krayer"]
tags: [bcg, bcg-henderson-institute, ai-and-organisations, agentic-ai-governance]
employer: "[[Boston Consulting Group]]"
role: "Principal, Boston Consulting Group; People & Organization, Technology and AI teams; BCG Henderson Institute Ambassador"
confidence: 0.75
...
LIST
FROM "wiki/sources"
WHERE contains(file.outlinks, this.file.link) OR contains(author, "Lisa Krayer")
SORT file.name DESC
```
