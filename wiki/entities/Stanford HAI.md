...
type: entity
kind: org
aliases: ["Stanford Institute for Human-Centered Artificial Intelligence", "HAI", "Stanford HAI"]
...
- **Briefs major companies and government agencies** on the state of AI: per [[2026-04-28-ai-index-report-2025|AI Index 2025]], briefings to Accenture, IBM, Wells Fargo, and Fidelity.
- **Cited in major media** (NYT, Bloomberg, Guardian) and hundreds of academic papers.

## Notable people (mentioned in this wiki)

Faculty and affiliates referenced via [[2026-04-28-ai-index-report-2025|AI Index 2025]]:
...
Per [[2026-04-28-ai-index-report-2025|AI Index 2025]] supporting partners: Google, NSF, OpenAI, Open Philanthropy, [[Quid]]. Note: HAI's broader funding model goes beyond these; this list is specifically the AI Index 2025 supporters.
...
LIST
FROM "wiki/sources"
WHERE contains(file.outlinks, this.file.link) OR contains(tags, "stanford-hai")
SORT file.name ASC
```
