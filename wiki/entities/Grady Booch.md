...
type: entity
kind: person
aliases: ["Grady Booch", "Grady BCH"]
tags: [grady-booch, uml-creator, gang-of-four-design-patterns, third-golden-age-of-software-engineering, agentic-design-patterns-call, ibm-fellow, software-engineering-history]
...
- [[2026-05-22-everitt-jetbrains-deeplearningai-ai-dev-26-sf-shift-to-agentic-engineering]] — cited extensively as the conceptual-lineage anchor for the *agentic engineering* reframe; the *third golden age of software engineering* podcast; the *Gang-of-Four-for-AI* call.
...
LIST
FROM "wiki/sources"
WHERE contains(file.outlinks, this.file.link) OR contains(tags, "grady-booch")
SORT file.name ASC
```
