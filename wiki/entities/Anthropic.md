...
- [[Anthropic Economic Index]] — recurring measurement of real-world Claude usage on Claude.ai (consumer) and 1P API (enterprise).
...
- [[Claude Sonnet 4.5]] — predominant model in the November 2025 Economic Index sample.
- [[Claude Opus 4.5]] — referenced as released after the November 2025 sample.
