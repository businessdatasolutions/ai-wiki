...
Computer-vision researcher. Since 2021, **Research Director at Salesforce Research** and **Adjunct Professor of Computer Science at Stanford University**. Co-Director of the Stanford Vision and Learning Lab. Previously Senior Research Scientist at the Stanford AI Laboratory and Associate Director of Research at the Stanford–Toyota Center for AI Research (2015–2021).
...
LIST
FROM "wiki/sources"
WHERE contains(file.outlinks, this.file.link) OR contains(tags, "niebles")
SORT file.name ASC
```
