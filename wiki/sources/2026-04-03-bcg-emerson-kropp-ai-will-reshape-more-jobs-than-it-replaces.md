...
author: ["Greg Emerson", "Matthew Kropp", "Julie Bedard", "Lisa Krayer", "Viacheslav Romanov", "Megan Hsu", "Luis Sanchez Boedo", "Diya Mohnot"]
publisher: "Boston Consulting Group (BCG Henderson Institute)"
...
length: "~22 pages (full text read; exhibits described from captions)"
raw: "../../raw/reports/1779460203012.pdf"
tags: [bcg, bcg-henderson-institute, ai-employment-effects, reshape-not-replace, ai-labor-disruption-segments, substitution-vs-augmentation, demand-expandability, jevons-paradox, reskilling, upskilling, career-ladders, six-segments, entry-level-exposure, matthew-kropp, workforce-strategy, ceo-recommendations]
...
relationships:
  - type: published-by
    target: Boston-Consulting-Group
    via: "BCG Henderson Institute microeconomic labor-impact modeling; the AI Labor Disruption Segments are BCG-proprietary"
  - type: supports
    target: 2026-05-06-kropp-bcg-hbr-dont-treat-ai-agents-like-employees
    via: "companion BCG labor analysis with overlapping authors (Kropp, Bedard, Krayer, Hsu) — the workforce-segmentation half of the same BCG view that 'don't treat agents like employees, redesign the work'"
  - type: supports
    target: 2026-03-05-massenkoff-mccrory-anthropic-labor-market-impacts-ai
    via: "method-independent convergence: BCG's microeconomic role-modeling and Anthropic's usage-based observed-exposure reach the same headline — reshape ≫ replace, slow substitution, entry-level exposed first, not a near-term mass-unemployment story"
  - type: supports
...
A **Boston Consulting Group** (BCG Henderson Institute) report (3 April 2026), lead author **Greg Emerson** with **[[Matthew Kropp]]**, **[[Julie Bedard]]**, **[[Lisa Krayer]]**, Viacheslav Romanov, **[[Megan Hsu]]**, Luis Sanchez Boedo, and Diya Mohnot. It is the **consulting-firm microeconomic-modeling** counterpart to the wiki's labor-effects sources — and the workforce-segmentation companion to the same BCG team's [[2026-05-06-kropp-bcg-hbr-dont-treat-ai-agents-like-employees|"Don't Treat AI Agents Like Employees"]]. Its headline reframes the jobs debate: **reshape, don't (mostly) replace.**
...
| Segment | Logic | Share | Examples |
|---|---|---|---|
| **Amplified** | augment + expandable demand → employment stable/grows, wage inflation | **5%** | software engineering (today), advisory/judgment-intensive lawyers |
| **Rebalanced** | augment + bounded demand → headcount steady, roles redesigned, upskilling essential | **14%** | content marketing (→ omnichannel specialists), academic research |
| **Divergent** | substitute + expandable demand → uneven; **entry-level/junior most exposed**, seniors persist/grow | **12%** | insurance sales agents, IT support technicians |
| **Substituted** | substitute + bounded demand → net job losses, downward wage pressure | **12%** | call-center reps, certain financial-analyst roles |
| **Enabled** | AI embedded in day-to-day but work structure unchanged; skill bar rises | **23%** | clinical assistants, lab technicians |
| **Limited-Exposure** | low automation feasibility + low productivity headroom | **34%** | physicians, teachers |
...
- Publisher: [[Boston Consulting Group]] (BCG Henderson Institute).
- **Promoted to entities this ingest** (second-source rule — all also author [[2026-05-06-kropp-bcg-hbr-dont-treat-ai-agents-like-employees|the BCG agents-as-employees piece]]): [[Matthew Kropp]], [[Julie Bedard]], [[Megan Hsu]]. ([[Lisa Krayer]] already an entity.)
- **Dangling** (single-source authors, deferred): Greg Emerson (lead author, BCG MD), Viacheslav Romanov, Luis Sanchez Boedo, Diya Mohnot.
- Concepts: [[ai-employment-effects]], [[automation-vs-augmentation]], [[durable-skills]], [[micro-productivity-trap]], [[enterprise-ai-adoption]].

## Relationships

- *published-by* [[Boston Consulting Group]].
- *supports* [[2026-05-06-kropp-bcg-hbr-dont-treat-ai-agents-like-employees]] — companion BCG labor analysis, overlapping authors.
- *supports* [[2026-03-05-massenkoff-mccrory-anthropic-labor-market-impacts-ai]] — method-independent convergence on reshape ≫ replace.
- *supports* [[2026-04-28-brynjolfsson-canaries-coal-mine]] — entry-level exposure as the leading edge.
