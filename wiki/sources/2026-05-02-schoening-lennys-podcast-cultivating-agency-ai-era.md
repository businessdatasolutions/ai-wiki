...
publisher: "Lenny Rachitsky (Lenny's Podcast YouTube channel — interview with Max Schoening, head of product at Notion)"
url: "https://www.youtube.com/watch?v=mCO-D3pkviM"
date_published: 2026-05-02
date_ingested: 2026-05-22
length: "~87:22 minutes (auto-generated English captions; ASR-cleaned, 1684 segments)"
raw: "../../raw/videos/ai-era-skills-why-cultivating-agency-matters-more-than-job-titles-max-schoening-notion.md"
tags: [max-schoening, notion, lennys-podcast, lenny-rachitsky, agency, durable-skills, designers-shipping-code, pms-shipping-code, malleable-software, tiny-core-theory, ink-and-switch, jeffrey-litt, saaspocalypse, founder-vantage, role-merging, notion-ai, build-vs-buy, ubi, agi]
...
relationships:
  - type: supports
    ...
    via: "**Two paired product-management-leader anchors on the *PMs/designers shipping code* thesis**, five months apart. Nika (Marily Nika, Dec 2025) names *PMs who use AI will replace PMs who don't* at the practice-management altitude; Schoening (May 2026) is the **operating worked example** at Notion: head of product running an org where designers and PMs ship code, prototype in the terminal, and launch AI products. Schoening's *Eric Lou* vignette (PM who shifted from PRDs → Figma → 'why can't I just build the prototype?') is the concrete instantiation of the role-evolution Nika prescribes."
  - type: supports
    target: 2026-05-19-mittal-yhangry-private-chef-all-in-on-ai-agents
    via: "**Two same-month founder-vantage articulations of the *tool-fluency-as-firing-criterion* thesis**, two-and-a-half weeks apart. Mittal (Yhangry, 19 May) says *'I fired my tech lead because I realized he did not know what skills was, and he was the ceiling in our company'*; Schoening (Notion, 2 May) says *'people who have true agency and understand that the world around them is malleable will do great; the folks who stick to what does it mean to be a PM, what does it mean to be a designer, will struggle.'* Same observation — *operators who don't know the current tooling are the ceiling* — at two operating scales (Yhangry's small marketplace + Notion's product org), with Mittal naming what *firing* sounds like and Schoening naming what *thriving* looks like."
  - type: supports
    target: 2026-05-20-tan-hu-stanford-cs153-ai-native-company-1000x-engineer
    via: "**Schoening's *agency / drive Notion like it's stolen* doctrine is the practitioner-altitude counterpart to Tan & Hu's *AI founder type / IC / DRI* org structure prescription.** Hu names the structural archetype (IC + DRI + AI founder type); Schoening names what the IC + DRI roles look like in practice when fully internalised at a mature-product-company scale. The *Brian Leven* vignette (Notion designer who blurs eng/design + is the company's #1 recruiter) is the worked example of Hu's *AI founder type* characteristic *still builds, still coaches, leads by example* applied below the founder layer."
  - type: supports
    target: 2026-05-21-chase-langchain-interrupt-26-future-of-ai-agents
    via: "**Schoening's *domain-experts-creating-tools* observation is the consumer-of-the-vendor-platform vantage to Chase's *everyone-builds-agents* prediction.** Chase / Interrupt 26 predicts *we think in the future they'll be even more involved in creating these agents; they're not just going to be giving feedback on them and handing that off to a separate team, they're actually going to be involved in building these agents* — Schoening at Notion is *already operating that way today*: designers and PMs prototype directly in code; *malleable software* is the default expectation rather than the exception; the company's product team owns the tools-they-use rather than asking engineering to build them."
  - type: supports
    target: 2026-04-25-masad-replit-ceo-only-two-jobs-left
    via: "**Two paired 2026 founder-altitude *malleable software / vibe-coding for non-developers* anchors**, one month apart. Masad / Replit (25 April) frames the *only two jobs left = builder + salesperson* doctrine from the platform-vendor altitude (Replit as the substrate that enables non-developers to build); Schoening (2 May) is the **customer-of-the-platform** vantage — what it looks like when the people inside a product company internalise *I can just make tools* as the default mode. Schoening's *Ink & Switch / Jeffrey Litt / Geoffrey Litt-collaborator* citation gives the wiki its first lineage-anchor for the *malleable software* tradition that predates the AI revolution and that Schoening is operationalising at Notion."
---
...
This is the wiki's clearest single articulation of **agency as a [[concepts/durable-skills|durable skill]]** at the founder/product-leader altitude — distinct from the *taste / judgement* framings the wiki carries (Karpathy, Hu, Mittal, Bender) by being explicitly about *the disposition to act* rather than *the discernment of quality*.
...
The Eric-Lou story is the wiki's clearest narrative arc of a **PM-evolving-into-builder-via-agency** — the practitioner-altitude instantiation of [[2025-12-01-marily-nika-pms-who-use-ai-will-replace-those-who-dont|Nika's]] prescription from five months earlier.
...
| Framing | Source | What it means |
|---|---|---|
| **Taste** | [[2026-04-29-andrej-karpathy-from-vibe-coding-to-agentic-engineering\|Karpathy]]; [[2026-05-20-tan-hu-stanford-cs153-ai-native-company-1000x-engineer\|Hu]] | Discernment of quality output — the eval-of-the-eval |
| **Judgement** | [[2026-04-21-forsgren-macvean-build-core-skills-thrive-ai-era-developer\|Forsgren]] (*"delegate tasks, not judgement"*) | Knowing what to delegate vs what to keep |
| **Agency** (this source) | **Schoening** | The disposition to act / make / change things — *prior* to taste or judgement |

**Schoening's *agency* sits upstream of taste and judgement** — you can have taste without doing anything with it, and you can have judgement without exercising it; agency is the disposition to act on either. The wiki's [[concepts/durable-skills]] page now has its first explicit *agency*-anchor and can frame agency as the load-bearing precursor to taste-and-judgement rather than as a synonym for them.
...
- [[Lenny's Podcast]] — already entity. Bumps source-count.
...
- [[concepts/durable-skills]] — major addition: **agency as the load-bearing durable AI-era skill**, distinct from taste and judgement. The Eric-Lou and Brian-Leven vignettes as the wiki's clearest practitioner-altitude worked examples of agency-in-action.
- [[concepts/ai-employment-effects]] — adds the *role-merging concern (we will lose specialists)* and the *prototype-vs-engineering distinction at AI-era scale* — the 3D-printed-prototype-vs-100M-user-factory metaphor as a load-bearing framing for *what gets lost when everyone becomes a builder*.
- [[concepts/agentic-engineering]] — adds Schoening's *agency / disposition to make* framing as the **practitioner-side counterpart** to Karpathy's *agentic engineering is a discipline* framing. Karpathy names the discipline; Schoening names the disposition that produces practitioners of the discipline.
- [[concepts/enterprise-ai-adoption]] — adds the *malleable software* tradition as a long-arc design philosophy that the current AI tooling is operationalising. The Ink & Switch lineage is a non-AI-native intellectual tradition that the wiki has not previously anchored.
- [[concepts/vibe-coding]] — adds the *"first 10% of every project is now free"* chapter-title claim (not read in full but flagged for future ingest); the *designers prototyping in the terminal* worked example at Notion's product-org altitude.

## Source quality

- **Channel**: [[Lenny's Podcast]] — product-management podcast; long-form interview format; high audience overlap with the wiki's existing product-leader-focused sources ([[2025-12-01-marily-nika-pms-who-use-ai-will-replace-those-who-dont|Nika]], [[2026-05-07-singhal-stanford-cs153-product-management-in-ai-era|Singhal]]).
