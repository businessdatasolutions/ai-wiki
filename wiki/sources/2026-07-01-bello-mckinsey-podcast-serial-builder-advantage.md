...
url: "https://www.youtube.com/watch?v=kzAjzKCZAXs"
date_published: 2026-07-01
date_ingested: 2026-07-04
length: "~25:30 minutes (transcript 614 segments; auto-generated captions)"
raw: "../../raw/videos/the-serial-builder-advantage-why-repeat-innovators-win.md"
tags: [mckinsey, mckinsey-podcast, jason-bello, roberta-fusaro, corporate-venture-building, serial-builder-advantage, portfolio-approach, dynamic-funding, milestone-based-funding, ai-native-business, synthetic-personas, vibe-coded-prototypes, fact-based-culture, business-building]
...
relationships:
  - type: supports
    ...
    via: "Both articulate the same portfolio-of-bets + milestone-tranche-funding mechanism from the incumbent-innovation vantage — Bello's cross-company McKinsey research (3+ simultaneous ventures dramatically outperform one-shot builders; break-even cost fell $125M→$77M 2024→2025) is the quantified cross-firm claim; DBS's Innovation Pyramid + QPR/slush-fund dynamic funding is the single-firm lived instance of the identical mechanism (fund in tranches, de-risk, kill early on fact not shame)."
    confidence: 0.85
  - type: supports
    target: 2026-06-25-carroll-stanford-gsb-making-organizational-culture-great
    via: "Bello's practitioner claim — a fact-based, blame-free culture ('if the facts tell us our product stinks, so be it') is what lets venture teams pivot fast without shame — is a lived instance of Carroll's academic thesis that strong culture is a social-control system aligned to strategy; both map to the strategic-renewal/organizational-culture cell."
    confidence: 0.7
  - type: supports
    target: 2024-04-18-caldwell-lennys-podcast-lessons-1000-yc-startups-tarpit-ideas
    via: "Cross-context parallel: Caldwell's YC doctrine of fast, fact-based pivoting away from tar-pit ideas (external startups) and Bello's fact-based, no-shame pivoting on corporate ventures (internal incumbents) describe the same underlying mechanism — fast course-correction driven by evidence rather than personal-failure narratives — in two different populations of builders."
    confidence: 0.6
---
...
- A concrete, named mechanism (milestone-tranche funding, ring-fenced reporting line to a C-suite exec) for `digital-seizing/rapid-prototyping` and `strategic-agility`, directly comparable to [[2026-06-18-dumra-mit-smr-dbs-everyone-an-innovator|DBS's]] Innovation Pyramid + QPR/slush-fund system.
- A sharply-worded articulation of the **fact-based, blame-free culture** mechanism for `strategic-renewal/organizational-culture` — "get the facts on the table... there's no fingerpointing" — that sits alongside [[2026-06-25-carroll-stanford-gsb-making-organizational-culture-great|Carroll's]] academic culture-as-social-control-system theory and [[2026-05-24-erginbilgic-bloomberg-leaders-rolls-royce-turnaround-playbook|Erginbilgiç's]] non-digital performance-culture case.
