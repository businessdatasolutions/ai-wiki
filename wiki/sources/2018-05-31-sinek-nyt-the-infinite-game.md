...
length: "~25:48 minutes (transcript ~633 lines after ASR-rolling dedup)"
raw: "../../raw/videos/2018-05-31-sinek-nyt-the-infinite-game.md"
tags: [leadership, infinite-game, finite-game, just-cause, simon-sinek, courageous-leadership, worthy-rival, vietnam-war, apple-vs-microsoft, long-horizon-leadership, short-termism, corporate-purpose]
roles: [ceo, coo, cso, chro, cmo, transformation-lead, innovation-lab-lead]
relationships:
  - type: instance-of
    target: infinite-game
    via: "this 2018 NYT Events keynote is the wiki's anchor primary source for the [[infinite-game]] concept page; the five-element checklist and Vietnam/Apple-Zune anecdotes are lifted directly from this source"
  - type: supports
    target: 2024-06-13-jordan-hbr-7-key-tensions-every-leader-must-balance
    via: "both sources reject command-and-control / single-style leadership. Sinek frames the rejection as 'finite vs infinite game' (different mindset; long-horizon purpose); Jordan frames it as 'balance seven style tensions' (paradox-thinking; switch contextually). Different vocabularies, same underlying argument that adaptive multi-mode leadership beats single-style leadership."
  - type: supports
    target: 2026-05-15-sterman-systems-thinking-for-leaders-designing-solutions-that-work
    via: "Sinek's 'infinite player understands sometimes your competitor has the better product and sometimes you have the better product […] you're only competing against yourself' is the multi-decade-horizon, multi-stakeholder framing that Sterman names as the systems-thinking embedding. Sinek motivates from leadership; Sterman from feedback dynamics."
---
...
- **First leadership / corporate-purpose source in the wiki.** The wiki's existing leadership-adjacent material ([[durable-skills]], the McKinsey-Sternfels-hiring-overhaul item, [[2026-02-09-ross-schneider-adaptability|Ross & Schneider 2026]] on adaptability replacing resilience) sits inside the *modern AI-era leadership* thread. Sinek 2018 is the older, more philosophical anchor — the long-horizon-mindset reframe of corporate purpose.
- **Pairs with [[2024-06-13-jordan-hbr-7-key-tensions-every-leader-must-balance|Jordan 2024]] on the rejection of single-style command-and-control leadership.** Sinek frames the rejection as a *mindset/horizon* problem; Jordan as a *style-balance* problem. Both reject the same target.
- **Pairs with [[2026-05-15-sterman-systems-thinking-for-leaders-designing-solutions-that-work|Sterman 2026]] on multi-stakeholder long-horizon reasoning.** Sinek's *"you're only competing against yourself"* and *"how do we improve the quality of our culture, the quality of the service we claim to provide"* are the leadership-mindset expression of Sterman's feedback-loop systems-thinking ([[systems-thinking]]). The two motivate the same operational stance from different vocabularies.
- **Tension with [[2022-06-29-martin-hbr-a-plan-is-not-a-strategy|Martin 2022]]'s Southwest example — resolved.** The flagged finite-vs-infinite-game productive tension is filed in the [[strategy-finite-vs-infinite-game]] synthesis (2026-05-18). Headline finding: Sinek operates *one layer above* the strategy lenses — *which game you are in* vs Martin's *how to win the round*. The two framings emphasise different time horizons; the apparent contradiction is a layered difference, not a supersession event. See the synthesis for the full nine-lens cross-walk.
