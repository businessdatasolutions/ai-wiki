...
author: ["Jared Moon", "Rory Walsh", "Vito Di Leo", "Adam Thelwall"]
publisher: "[[McKinsey & Company]] (McKinsey Technology — May 2026)"
section: "McKinsey Technology"
url: "https://www.mckinsey.com/capabilities/mckinsey-digital/our-insights/rewiring-software-delivery-for-the-agentic-era"
date_published: 2026-05-28
date_ingested: 2026-05-29
length: "~7 pages (browser-print PDF). Full article body ingested. Three illustrative McKinsey-analysis exhibits: (1) the day-shift / night-shift 24-hour-sprint timeline; (2) the agent-squad pipeline across Requirements → Design → Code/Test → Deploy; (3) the team-size quantification — 100 → 60 FTEs / 200 → 100 person-years / 10 teams of 8-12 → 16 teams of 3-4 / team composition collapsed from 10-role to 3-role pod."
raw: "../../raw/articles/Rewiring software delivery for the agentic era _ McKinsey.pdf"
tags: [jared-moon, rory-walsh, vito-di-leo, adam-thelwall, mckinsey-technology, mckinsey-digital, agentic-software-delivery, 24-hour-sprint, day-shift-night-shift, factory-of-agents, librarian-agent, knowledge-graphs-as-ai-memory-layer, knowledge-as-production-infrastructure, outer-loop-roles, policy-as-code, rewire-the-operating-model, 3x-5x-productivity-improvements, 60-percent-team-size-reduction, 50-percent-effort-reduction, 8-12-to-3-4-fte-pods, mckinsey-altitude-sdlc-redesign, brownfield-rebuild, legacy-modernization, supervising-the-system-that-produces-artifacts, controls-baked-in-by-design]
...
relationships:
  - type: supports
    ...
    via: "**Same-firm McKinsey 3-month-update follow-up: from *firm-level reinvention thesis* (Sternfels, February 2026) to *software-delivery operational mechanism* (Moon-Walsh-Di-Leo, May 2026).** [[2026-02-09-sternfels-mckinsey-survive-ai-and-reinvent-consulting|Sternfels / McKinsey 2026]] (Feb 9, McKinsey Quarterly): the *firm-level reinvention* normative argument — *'AI is rewriting the rules of consulting'* + *'reinvent consulting'* + *'survive AI'* — at the **Managing Partner altitude** (Bob Sternfels was Global Managing Partner at the time). This Moon-Walsh-Di-Leo source (May 28, McKinsey Technology) is the **same-firm 3-and-a-half-month-later operational specification** of how that reinvention happens *inside the software-delivery domain*: the 24-hour-sprint day-shift / night-shift model, the factory-of-agents pipeline, the knowledge-graph-as-AI-memory-layer infrastructure, the 8-12 → 3-4 FTE pod resizing, the outer-loop role integration. Sternfels names the *what* (consulting must reinvent itself or be reinvented); Moon-Walsh-Di-Leo name the *how* (here is the operating-model rewiring inside one work domain). Same-firm, same direction, three months apart, two altitudes — managing-partner-doctrinal-altitude + tech-partner-operational-altitude."
    confidence: 0.9
  - type: supports
    target: 2026-05-21-allen-aws-london-exec-forum-agentic-team-structures
    via: "**McKinsey-altitude quantification of AWS's Project-Mantle worked example one week earlier.** [[2026-05-21-allen-aws-london-exec-forum-agentic-team-structures|Allen / AWS London Executive Forum]] (May 21): the **Project Mantle case** — Bedrock substrate rebuild in 76 days vs an 18-month estimate, AWS VP-Distinguished-Engineer Anthony Liguori + L7 principals, goal-based agents — plus the **embedded-pod model** (3-5 engineers per pod organised around workflow not product) and the **hourglass organisation** as counter to *seniors-20×-cut-juniors* default. Moon-Walsh-Di-Leo (May 28, one week later) supply the **McKinsey-aggregated-quantitative-experience anchor** of the same phenomenon at consulting altitude: *'across multiple companies'* (per the Exhibit 3 footnote), ~50% reduction in total effort (200 person-years → 100), ~60% reduction in average team size (10 teams of 8-12 → 16 teams of 3-4), and a 10-role pod composition (Product owner / Business analyst / Tech lead / 5 Software engineers / 2 Testers) collapsing to a 3-role pod (Product owner / Tech lead / AI-enabled engineer). The AWS-side anchor names *one quantified data point at L7-principal altitude* (76 days vs 18 months); the McKinsey-side anchor generalises it to *the median across multiple-company observation*. One week apart, two altitudes, structurally identical team-shape claim."
    confidence: 0.9
  - type: supports
    target: 2026-05-20-ng-deeplearningai-ai-dev-26-sf-future-of-software-engineering
    via: "**Convergent quantification of the *PM-bottleneck cascading-bottlenecks small-team-of-generalists* thesis.** [[2026-05-20-ng-deeplearningai-ai-dev-26-sf-future-of-software-engineering|Ng / AI Dev 26 SF]] (May 20): the *PM-to-engineer ratio collapse — from typical 1:8 toward 1:2 and 1:1, then collapsing into single-human-doing-both* observation + the *small-teams-of-generalists* prescription. Moon-Walsh-Di-Leo (May 28, eight days later) supply the **McKinsey-altitude quantification of the same team-shape collapse**: 10-role pods (Product owner + Business analyst + Tech lead + 5 Software engineers + 2 Testers) → 3-role pods (Product owner + Tech lead + AI-enabled engineer). Ng's *engineers-who-shape-products + PMs-who-can-code* observation is operationalised by McKinsey's *AI-enabled engineer* as the new generalist role-archetype. The collapse from 10 → 3 named roles in a pod is the McKinsey-altitude empirical anchor for Ng's *engineer-plus-PM collapse into single human* claim — same observation, conference-keynote-altitude + consulting-altitude vantages."
    confidence: 0.8
  - type: supports
    target: 2026-05-27-koomen-yc-lightcone-inside-yc-ai-playbook
    via: "**Consulting-altitude operational specification of Koomen's YC-internal *multiplayer-harness primitive set* — same week, two altitudes converging on *knowledge-as-production-infrastructure*.** [[2026-05-27-koomen-yc-lightcone-inside-yc-ai-playbook|Koomen / YC Lightcone]] (May 27, one day before Moon-Walsh-Di-Leo): the **YC-internal-infrastructure operationalisation** of multi-player harness — *one Postgres database to rule them all + 350-tool shared registry + skillify / DRY / MECE resolver pattern + dream cycle + broadcast-by-default agent conversations*. McKinsey (May 28) supply the **consulting-altitude abstraction layer**: the *factory of agents* + the *knowledge graphs as AI memory layer* + the *librarian agent* drawing from structured institutional memory + the *implicit tribal knowledge becomes explicit and explainable* claim + *knowledge becomes production infrastructure, rather than static documentation, and a durable source of competitive advantage*. Koomen's *one-database-substrate* is the YC-internal worked example of McKinsey's *knowledge architecture as strategic infrastructure* prescription. The **shared-week declarations on *knowledge-as-production-infrastructure*** at two altitudes (YC-founder + McKinsey-tech-partner) within 48 hours."
    confidence: 0.85
  - type: supports
    target: 2025-11-25-yee-mgi-agents-robots-and-us-skill-partnerships
    via: "**Two McKinsey-internal vantages on the *44%-via-agents nonphysical-work* claim — MGI quantitative substrate + Tech-partner operational specification, 6 months apart.** [[2025-11-25-yee-mgi-agents-robots-and-us-skill-partnerships|Yee et al. / MGI]] (Nov 2025): the **Skill Change Index** + **57% US technical-automation-potential = 44% via agents (nonphysical) + 13% via robots (physical)** + the **workflow-not-task imperative** (*'190+ workflows mapped across 16 business functions as the operational unit-of-analysis; nearly 90% of companies say they have invested in AI, but fewer than 40% report measurable gains'*) + the **7-occupation-archetype framework** at the **MGI macroeconomic altitude**. Moon-Walsh-Di-Leo (May 2026, 6 months later, same McKinsey institutional context) supply the **tech-partner operational specification** of MGI's structural claim inside one domain (software delivery): the 24-hour sprint + factory of agents + knowledge graphs + ~60% team-size reduction. MGI names the *macro substrate at ~6,800 skills × ~1,800 occupations*; Moon-Walsh-Di-Leo land *inside the agent-centric quadrant* (one of MGI's seven archetypes) with software development as the worked example. Cross-McKinsey-internal converging declaration — same firm, two research arms (MGI + McKinsey Digital), same direction, 6-month delta."
    confidence: 0.8
---
...
- **Raw PDF (7 pp)**: [article file](../../raw/articles/Rewiring%20software%20delivery%20for%20the%20agentic%20era%20_%20McKinsey.pdf) — browser-print save from mckinsey.com.
- **Public URL**: [mckinsey.com/capabilities/mckinsey-digital/our-insights/rewiring-software-delivery-for-the-agentic-era](https://www.mckinsey.com/capabilities/mckinsey-digital/our-insights/rewiring-software-delivery-for-the-agentic-era)
