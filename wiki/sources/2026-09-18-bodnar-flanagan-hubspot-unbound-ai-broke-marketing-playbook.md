...
type: source
kind: video
title: "AI Broke the Old Marketing Playbook | Kipp Bodnar & Kieran Flanagan | UNBOUND 2026 | HubSpot Live"
author: ["HubSpot Live"]
publisher: "HubSpot Live — UNBOUND 2026 main-stage session by Kipp Bodnar (CMO, HubSpot) and Kieran Flanagan (HubSpot Media host); launch talk for their book *Loop*"
url: "https://www.youtube.com/watch?v=5HyxRagA2B0"
date_published: 2026-09-18
date_ingested: 2026-09-19
length: "~28:52 minutes (transcript ~223 segments; auto-generated captions, ASR-cleaned; slides not visible)"
raw: "../../raw/videos/ai-broke-the-old-marketing-playbook-kipp-bodnar-kieran-flanagan-unbound-2026-hubspot-live.md"
tags: [hubspot, unbound-2026, kipp-bodnar, kieran-flanagan, loop-marketing, marketing, zero-click-search, ai-search, organic-traffic, hourglass-funnel, value-over-volume, taste, taste-profile, judgment, sea-of-sameness, content-deluge, content-half-life, remarkable-and-relentless, creative-as-targeting, roas, first-party-data, sprints, rapid-iteration, marketing-against-the-grain, vendor-keynote]
dynamic_capabilities:
  - contextual/external-triggers
  - digital-seizing/strategic-agility
  - digital-seizing/rapid-prototyping
roles: [cmo, ceo, cso, product-manager]
relationships:
  - type: supports
    target: 2026-05-11-ognibeni-ai-agents-cool-demos-vs-real-revenue-china
    via: "the search-driven funnel breaking. Ognibeni predicted in May 2026 that search-driven e-commerce is the format AI agents kill first; HubSpot reports it happening to its own funnel — an 80% drop in traffic, 140 million visits lost in a year, as buyers moved their research into ChatGPT and Claude"
    confidence: 0.75
  - type: supports
    target: 2026-02-09-hubspot-customer-success-with-claude
    via: "the same firm naming taste as marketing's scarce input seven months apart. HubSpot's marketing lead chose Claude because 'marketing's all about taste'; Bodnar and Flanagan make taste the first stage of their operating model and argue it must be written down and fed to the model, not delegated to it"
    confidence: 0.8
  - type: supports
    target: 2026-06-16-mollick-simon-sinek-ai-skills-experience-edge
    via: "taste as the differentiator once production is commoditised. Mollick calls taste the most valuable skill of the AI era; Flanagan's version is 'when the cost of production is free, judgment is the only thing that has a price', because AI returns 'the median of everything it was trained on, and that's where all of your competitors live'"
    confidence: 0.75
  - type: supports
    target: 2026-06-12-dellacqua-cybernetic-teammate-field-experiment-genai-teamwork
    via: "choosing, not making, is the scarce step. Dell'Acqua et al. find AI raises the quality of generated ideas while human judgment keeps its value in selection; Flanagan: 'Making is no longer the problem. Choosing is the problem. Choosing what to make'"
    confidence: 0.65
---
...
| --- | --- | --- |
| **Remarkable** | *invisible excellence* | ***remarkable and relentless*** (the target) |
| **Unremarkable** | *dead zone* | *slop factory* |
...
- **The search funnel breaking.** [[2026-05-11-ognibeni-ai-agents-cool-demos-vs-real-revenue-china|Ognibeni]] closed his May 2026 talk predicting that AI agents would kill search-driven e-commerce first. HubSpot reports that prediction arriving in its own marketing funnel, with numbers.
- **Taste, from the same firm.** In [[2026-02-09-hubspot-customer-success-with-claude|Anthropic's HubSpot customer story]], HubSpot said it picked Claude because *"marketing's all about taste."* Here taste becomes an operating procedure (the taste profile) rather than a procurement criterion.
- **Taste as the durable skill.** [[2026-06-16-mollick-simon-sinek-ai-skills-experience-edge|Mollick]] calls taste the most valuable skill of the AI era, and this talk is the marketing-practitioner version. [[2026-06-12-dellacqua-cybernetic-teammate-field-experiment-genai-teamwork|Dell'Acqua et al.]] provide the experimental version: AI lifts the quality of what is generated, and human judgment keeps its value in choosing. That is Flanagan's *"making is no longer the problem, choosing is."*
