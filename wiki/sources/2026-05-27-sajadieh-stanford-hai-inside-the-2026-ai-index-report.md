...
type: source
kind: video
title: "Inside the 2026 AI Index Report"
author: ["Stanford HAI"]
url: "https://www.youtube.com/watch?v=PoF-nWjX8bM"
date_published: 2026-05-27
date_ingested: 2026-05-28
length: "~1:12:52 minutes (auto-generated transcript, 547 ASR segments; YouTube screen-reader spelled-out timestamps stripped at clean-up)"
raw: "../../raw/videos/inside-the-2026-ai-index-report.md"
tags: [ai-index, stanford-hai, sajadieh, perrault, wald, ai-index-talk-track, absorption-gap, acceptability-threshold, jagged-frontier, us-china-gap, ai-sovereignty, public-sentiment-polarisation, foundation-model-transparency-index, panel-discussion]
...
relationships:
  - type: supports
    ...
    via: "**Talk-track for the published report.** Same author (Sha Sajadieh, EiC) presents the report's headline framing live; statistical claims overlap heavily (88% organizational adoption, 53% population GenAI adoption, $285.9B US private investment, 2.7% top-US/top-China gap as of March 2026, 89% AI-talent-inflow decline since 2017 with 80% in the last year, 362 AI incidents up from 233, 80/95 notable models released without training code, 84% of US high schoolers using AI for school work + <50% schools with policies + 6% teachers feeling prepared, US 31% trust in government to regulate effectively — lowest of any country surveyed). The talk-track adds material not in the report itself: a 42-minute panel Q&A with Raymond Perrault (co-founder, steering-committee co-chair) and Russell Wald (Stanford HAI Executive Director) covering AI-Index founding mission (*facts on the ground, not projections, no recommendations to governments*), the **acceptability-threshold research gap** (Perrault: *we know self-driving cars need very high reliability because people die; we don't know how reliable AI must be to be acceptable in legal / medical / finance*), the academic-vs-industry transparency tension (Wald's argument that frontier-lab proprietary mode hampers academic peer-review/verification), and Yolanda Gil + Perrault's World-Bank/IMF measurement initiative — agreement-in-principle from major US companies to share user/usage data for global-AI-adoption measurement, *not in time for next report*"
  - type: supports
    target: 2026-05-12-mgi-virtual-event-race-takes-off-next-big-arenas
    via: "**Sibling live-event-of-annual-landscape-report pattern at major-institution altitude.** Both render an annual landscape report into a live executive briefing + panel Q&A format; identical four-cell W&W profile (`digital-sensing/digital-scouting` + `digital-sensing/digital-scenario-planning` + `digital-seizing/balancing-digital-portfolios` + `contextual/external-triggers`). MGI emphasises the *arena-creation* axis (18 future arenas adding $18T market cap, nine omniscalers redistributing per-arena value at ~20×); AI Index emphasises the *absorption gap* axis (capability moving faster than governance / evaluation / data infrastructure / education can keep up). Both converge on the US-China narrowing, infrastructure concentration (omniscaler-capex / TSMC-foundry), and the public-trust gap as 2026's organizing facts."
  - type: supports
    target: 2026-04-28-ftsg-convergence-outlook-2026
    via: "**Two annual 2026 horizon-scans converging on the same empirical landscape from different vantages.** FTSG / Webb anchor the *convergence-as-power-redistributor* thesis (rule 3: convergences redistribute power and value across — not just within — industries) and the *creative-destruction-from-within* normative argument. The AI Index talk anchors the same empirical phenomena via *facts on the ground, not projections*: US-China gap narrowing (FTSG's *redistribute power* rule playing out at the model-frontier altitude), industry concentration of frontier models at 91% (FTSG's *capital concentrates rapidly* enabling condition operationalised), the public-trust polarization (FTSG's *legitimacy of existing order erodes* enabling condition empirically measured). Different framings, same 2026 landscape."
---
...
1. **0:00 – 30:46** — [[Sha Sajadieh]] (Editor-in-Chief, [[AI Index]], 2026 edition) presents the report's headline framing.
...
This is **the talk-track for [[2026-04-30-ai-index-report-2026|the 2026 AI Index Report]]**. Statistical claims overlap heavily with the published report; the genuinely new material is the panel Q&A, which is the focus of the body summary below.
...
The presentation walks the report's chapter highlights in roughly the same order as the published report's *15 Top Takeaways* (see [[2026-04-30-ai-index-report-2026|the 2026 AI Index Report page]] for the full list). The talk-specific compressions worth noting:
...
- The ASR-channel attribution *"Stanford HAI"* is the canonical channel name and goes into `author:` per [§Source-page conventions specific to videos](../../CLAUDE.md#source-page-conventions-specific-to-videos).
