...
type: source
kind: article
title: "Resilience Won't Save Your Organization. Adaptability Will"
subtitle: "How AI is changing the leadership skills needed to succeed"
author: ["Mike James Ross", "Greig Schneider"]
publisher: "[[Harvard Business Review]]"
section: "Partner Content from Egon Zehnder"
journal_volume: "HBR.org Partner Content, 9 February 2026"
date_published: 2026-02-09
date_ingested: 2026-05-12
tags: [hbr, hbr-partner-content, egon-zehnder, leadership, adaptability, resilience, hiring, change-management, advertorial]
length: "~6 pages"
raw: "../../raw/articles/Resilience Won’t Save Your Organization. Adaptability Will - PARTNER CONTENT FROM EGON ZEHNDER.pdf"
---
...
This is the wiki's first **HBR Partner Content** source. The format matters for confidence calibration (see [§Source-quality flag](#source-quality-flag)).
...
1. **Continuously structure (and restructure) agile teams.** Break silos; cross-functional teams reconfigurable as priorities shift.
2. **Harness the power of diverse perspectives.** Multi-functional groups spark more creative solutions to complex challenges.
3. **Nurture productive conflict.** Hill's *"creative abrasion"* — make space for constructive challenge and divergent thinking; *"not about finding a single right answer but fostering an ongoing creative journey."*
4. **Bring the outside in.** Per *Genius at Scale*, reach beyond organisational boundaries — partnerships and ecosystems for continual growth.
...
1. **Seek (minor) discomfort.** Take a different route to work; brush your teeth with the opposite hand; move where/when/how your teams meet. *"Teaching yourself and your teams that change is not to be feared, and that newness is good."*
2. **Reframe situations.** When bumps appear, ask *"What is this teaching me, and how can I benefit from it?"* The CEO survey's headline prescription for mastering today's complexity: *"Cultivating a culture of curiosity and open-mindedness."*
3. **Practice adapting.** Plan to do new things — wander a new part of your hometown without a plan; give teams shorter time-frame challenges and force more dynamic next-step pivots.
...
- **[[Linda Hill]] — promoted 2026-08-20.** Hill is cited substantively here (*Collective Genius*, *"What Makes a Great Leader?"*, then-forthcoming *Genius at Scale*, *"creative abrasion"*) but is not an author of this source, so she was left dangling and flagged for promotion on a second source. That second source arrived: [[2026-08-16-hill-bloomberg-leaders-ceo-skills-age-of-ai|her August 2026 Bloomberg *Leaders* interview]], where she is the principal speaker and states the four adaptable-leader practices, creative abrasion, contextual intelligence and wayfinding directly. She now has an entity page. Note also that this source vindicates the interviewer in that later episode: Ross & Schneider citing *Genius at Scale* as forthcoming in February 2026 is what established that Lacqua's August book list was correct as spoken.
...
**Entities (this wiki):** [[Linda Hill]] (promoted 2026-08-20 on her second citation — see the cross-source-positioning note above), [[Harvard Business Review]] (publisher; bumps source_count by 1; this is the first HBR Partner Content piece in the wiki — new sub-table on the HBR entity page). 

**Dangling** (single-source mention, deferred per the [author-entity promotion rule](../../CLAUDE.md#author-entity-promotion)): Mike James Ross, Greig Schneider (Egon Zehnder partners; this article authors), Etienne van der Walt (neurologist; CEO/founder of Neurozone; cited definition of resilience), Egon Zehnder (sponsoring firm; the authors' employer — analogous to how AWS sits behind Werner-Le-Brun), Neurozone (van der Walt's firm), La Maison Simons (Ross's former employer, mentioned in bio).
...
**Threads/syntheses:** Not added to the [[syntheses/organizational-frameworks-for-ai-adoption|organizational-frameworks-for-ai-adoption]] synthesis — the synthesis is built on 12 mostly-rigorous sources, and adding an advertorial would dilute that cluster. The connection is captured here in cross-source positioning and on the relevant adjacent source pages.

## Source

- **Raw PDF (~6 pages):** [article file](../../raw/articles/Resilience%20Won%E2%80%99t%20Save%20Your%20Organization.%20Adaptability%20Will%20-%20PARTNER%20CONTENT%20FROM%20EGON%20ZEHNDER.pdf)
