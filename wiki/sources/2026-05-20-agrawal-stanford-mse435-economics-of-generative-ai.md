...
type: source
kind: video
title: "Stanford MS&E435 | Spring 2026 | Economics of Generative AI"
author: ["Stanford Online"]
publisher: "Stanford University (Stanford Online YouTube channel — MS&E435 Spring 2026 seminar Session 1; instructor Apoorv Agrawal of Altimeter Capital)"
url: "https://www.youtube.com/watch?v=ODj7ndsKnts"
date_published: 2026-05-20
date_ingested: 2026-05-22
length: "~34:13 minutes (auto-generated English captions; ASR-cleaned, 322 segments)"
raw: "../../raw/videos/stanford-mse435-spring-2026-economics-of-generative-ai.md"
tags: [apoorv-agrawal, altimeter-capital, stanford, mse435, economics-of-ai, ai-stack, where-is-the-money, capex-cycle, aws-analogy, palantir, semiconductor-layer, infrastructure-layer, foundation-models, application-layer, hyperscalers, vc-vantage]
...
relationships:
  - type: supports
    ...
    via: "**Two Stanford economic-vantages on AI published within a day of each other.** Jones (Stanford GSB economics professor) anchors the *weak-links macroeconomic-growth model* — productivity benefits slow because all weak links must be automated before the chain strengthens. Agrawal (Stanford MS&E adjunct lecturer + Altimeter Capital partner) anchors the *where-is-the-money industry-structure question* — which layer of the AI stack will capture the value? Same Stanford-academic-vantage on AI, opposite ends of the macro/micro spectrum: Jones asks *what does the GDP do*; Agrawal asks *which company makes the money*."
  - type: supports
    target: 2026-05-05-stanford-ai-club-chamath-on-how-to-win-in-the-ai-era
    via: "**Two Stanford-vantage VC-altitude framings of *AI as a supercycle*** at the venture-capital vantage. Chamath / Stanford AI Club anchors the *how to win in the AI era* practitioner framing; Agrawal / Stanford MS&E435 opens the *9-week seminar series* with the *AI is the biggest technology supercycle since the PC, Internet, and Mobile* framing. Both treat AI as a sustained capex-cycle phenomenon comparable to prior platform shifts; Agrawal's seminar opens with the *capex cycle takes 8 years (AWS broke ground 2004, first customer Netflix 2010, Amazon shifted fully 2012)* historical anchor."
  - type: supports
    target: 2026-04-30-ai-index-report-2026
    via: "**AI Index 2026 (catalogue) + Agrawal MS&E435 (analytical framing) paired Stanford ingests on the macro-AI-trajectory question.** AI Index quantifies the supply-side (compute, investment, capability); Agrawal asks the *industry-structure / value-capture* question on top of those measurements — which layer of the stack (semis, infrastructure, foundation models, applications) will end up with the gross margin? The seminar's central recurring question (*are you a feature or a platform?*) is the **investor-altitude diagnostic** for the industry-structure question."
---
...
- [[2026-04-30-ai-index-report-2026|AI Index 2026]] — supply-side measurements (compute, investment, capability).
- [[2026-04-28-anthropic-economic-index-q4-2025|Anthropic Economic Index]] — demand-side deployment measurements.
- [[2026-05-05-stanford-ai-club-chamath-on-how-to-win-in-the-ai-era|Chamath / Stanford AI Club]] — VC-altitude *how to win* framing.
- [[2026-05-21-jones-stanford-gsb-ai-and-our-economic-future|Jones / Stanford GSB]] — macroeconomic-growth weak-links model.
...
- [[Stanford Online]] — channel; already entity. Bumps source-count.
...
- [[concepts/foundation-models]] — adds the *foundation-models-as-the-middle-layer-of-the-AI-stack* industry-structure framing; the *are-you-a-feature-or-a-platform* hyperscaler-consolidation diagnostic.
- [[concepts/enterprise-ai-adoption]] — adds the *incremental-user-of-an-AI-application-is-not-free* gross-margin observation that distinguishes the current AI supercycle from the prior software-eats-the-world supercycle.
- [[concepts/strategic-foresight]] — adds the *AWS-8-year-capex-cycle-historical-analog* temporal anchor; the *AI is the biggest technology supercycle since PC, Internet, Mobile* framing.
