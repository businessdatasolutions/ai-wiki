...
type: source
kind: video
title: "The real AI advantage"
author: ["McKinsey & Company"]
url: "https://www.youtube.com/watch?v=BHQyOFaARQI"
date_published: 2026-07-09
date_ingested: 2026-07-09
length: "~20:27 minutes (transcript 155 segments; auto-generated captions)"
raw: "../../raw/videos/the-real-ai-advantage.md"
tags: [mckinsey, mckinsey-podcast, tanguy-catlin, roberta-fusaro, rewired, agentic-commerce, outcome-based-organization, general-purpose-technology, competitive-advantage, operating-model, change-management, proprietary-data]
...
relationships:
  - type: supports
    target: 2026-05-03-rewired-second-edition-sample
    via: "Catlin explicitly names the book ('We've written a book about it called Rewired') and restates its core prescription verbatim: pick a domain, don't bolt AI onto existing processes, redesign the process to capture the value, make it scalable, then expand — this podcast is the same McKinsey framework delivered in interview form."
    confidence: 0.9
  - type: supports
    target: 2026-05-11-ognibeni-ai-agents-cool-demos-vs-real-revenue-china
    via: "Both describe agentic commerce as a near-term structural shift — Catlin from a prescriptive/forward-looking McKinsey-research angle (agents transacting on a customer's behalf, e.g. auto-switching insurance at renewal), Ognibeni from an already-live descriptive angle (Chinese super-apps and dark factories) — same phenomenon, different maturity stage and evidentiary footing."
    confidence: 0.65
  - type: supports
...
- [[dynamic-capabilities]] — explicit `strategic-renewal/business-model` case (reinvention over productivity) plus `digital-seizing/strategic-agility` (the adaptable-operating-model argument).
- [[warner-wager-process-model]] — tagging vocabulary source; see `dynamic_capabilities:` above.
- [[enterprise-ai-adoption]] — productivity-gets-competed-away dynamic sharpens the wiki's existing adoption-maturity material.
...
- **Dangling** (single-source mention, deferred per [Author-entity promotion](../../CLAUDE.md#author-entity-promotion)): **Tanguy Catlin** (McKinsey Senior Partner and McKinsey Global Institute Director, interviewee) — first wiki mention; promote on second-source mention.
