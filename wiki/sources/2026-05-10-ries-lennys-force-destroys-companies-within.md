...
length: "~1:39:22 (transcript 1958 ASR lines; 27 chapters)"
raw: "../../raw/videos/ries-lennys-force-destroys-companies-within.md"
tags: [eric-ries, lean-startup, incorruptible-book, lenny-podcast, governance, public-benefit-corporation, mission-aligned-companies, shareholder-primacy, anthropic, openai, novo-nordisk, cloudflare, groupon, costco, founder-control, conways-law, ai-alignment-vs-human-alignment, the-force, harder-is-easier, culture-bank, torchbearers, mission-guardian, fiduciary-commitments]
---
...
1. **Founder ouster** — the founders themselves get fired. *"Only 20% of founders are still the CEO three years after going public."*
2. **Mission corruption** — the company stays alive but its purpose hollows out. *"It starts to become malign or bureaucratic or frankly evil."*
3. **Cumulative drift** — small concessions compound. Each compromise *seems reasonable in the moment*; the cumulative result is unrecognisable from the founding intent.
...
1. **For-profit board** (the standard corporate governance layer)
2. **Long-Term Benefit Trust (LTBT)** — an outside group of trustees who:
...
**Mission-hopeful** = the founder *intends* mission alignment but the structure provides no defence against the force.
**Mission-driven** = the structure makes mission betrayal *systematically harder than mission maintenance*.
...
- [[Anthropic]] — Ries supplies the operator-detail on the **Long-Term Benefit Trust** mechanism and narrates his own role advising the founders. Page updated; source_count and confidence bumped per [§Lifecycle](../../CLAUDE.md#lifecycle).
...
- **Lenny's Podcast** (channel = author of this source) — host **Lenny Rachitsky** (also mentioned in the wiki via [[2025-12-01-marily-nika-pms-who-use-ai-will-replace-those-who-dont|Nika 2025 / How I AI]] which names *Lenny's List*).
