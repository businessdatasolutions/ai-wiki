...
length: "~11:23 minutes (transcript ~85 lines; auto-generated ASR transcript, light cleanup applied for proper nouns and company names in the body — the ASR rendered *Cooley* as *Cooling*, *Casetext* as *Caseex*, *Panacea* as *Panace*, *Sam Altman* as *Sam Alman*, all corrected here)"
raw: "../../raw/videos/2026-06-03-warren-yc-how-to-build-an-ai-native-services-company.md"
tags: [charlie-warren, yc-visiting-partner, ai-native-services-company, outcome-as-product, co-pilot-as-product, four-market-traits, low-trust, low-task-judgment, high-intelligence-threshold, regulation-as-moat, sam-altman-test, robotics-segmented-out, domain-fluency, model-fluency, operational-rigor, panacea-fda-regulatory, general-legal-team, cooley-fenwick-founders, casetext-technical-leadership, humans-as-interface-not-product, humans-scale-nonlinearly, throughput-cycle-time-as-product-metrics, variance-existential-problem, early-demand-trap, pilot-is-the-product, sell-outcomes-not-seats-or-tokens, per-unit-pricing, outcome-based-pricing, cost-plus-pricing-trap, straight-line-undercutting-trap, p-and-l-walkthrough, 30-percent-services-margins, 50-percent-plus-ai-leveraged, ai-operating-leverage, tam-2-to-3-times-software, dont-buy-your-way-in, regulatory-moat-fast, building-better-than-buying, generational-company, the-process-is-the-product]
...
relationships:
  - type: supports
    target: 2026-05-05-nishar-nohria-end-of-one-size-fits-all
    via: "Direct vendor-side mirror of the buyer-side *Buy Outcomes* model. Nishar & Nohria (HBR, May 2026) frame Buy Outcomes from the *enterprise-buyer firm-boundary* angle: when a firm contracts for *accurate financials, compliance, and reporting as a service* rather than licensing software and operating it internally, the entire job (not just discrete tasks) is automated by the vendor — Adobe's outcome-based pricing is the named worked example. Warren (YC Startup School, June 2026) supplies the *startup-vendor go-to-market playbook* for building that vendor: *'companies provide the outcome to the customer versus build a co-pilot that the customer uses internally'*; markets *'two to three times bigger than software'*; per-unit + outcome-based pricing as the GO patterns; cost-plus + straight-line-undercutting as the AVOID patterns. The two pieces are direct architectural complements — Nishar-Nohria *names the buyer-side architecture*, Warren *names the vendor-side playbook for that architecture*."
    confidence: 0.9
  - type: supports
    target: 2026-04-09-dinakaran-yc-luminai-automating-americas-biggest-hospitals
    via: "Same Y Combinator vantage on AI-native services companies, different vertical. Dinakaran / Luminai (April 2026) is the wiki's first YC-altitude worked example of *AI-native services for hospital ops* (admin, scheduling, prior-auth, claims) inside the largest US hospital networks; Warren (June 2026) generalises the pattern into a YC-altitude *playbook* across tax / audit / insurance / mortgages / parts of healthcare / parts of logistics. Warren's market-selection traits (*low trust + low task-level judgment + high intelligence threshold + regulation-as-moat*) describe what Luminai operates inside; Luminai is one of the implicit existence-proofs Warren is generalising from. Pair as **playbook + worked example at same vantage**."
    confidence: 0.85
  - type: supports
    target: 2026-02-09-sternfels-mckinsey-survive-ai-and-reinvent-consulting
    via: "Convergent on the *professional-services-reinvention* thesis from two opposite altitudes. Sternfels (Feb 2026, McKinsey managing-partner altitude) argues consulting must reinvent under AI from inside the incumbent firm. Warren (June 2026, YC Visiting Partner altitude) describes the **vendor-startup side** of the same phenomenon: *'companies … rebuilt from scratch with AI doing most of the work'* in the same domains Sternfels identifies (tax, audit, insurance, parts of healthcare). Sternfels names what the incumbents must do; Warren names what the startup vendors are building to replace them if the incumbents don't move fast enough. Same phenomenon, two-sided framing — *incumbent-side rewrite + new-entrant-side scratch build*."
    confidence: 0.8
  - type: supports
    target: 2026-05-31-benedict-evans-rational-conversation-on-where-ai-is-actually-going
    via: "Convergent on the *AI labs invest in consultancies + forward-deployed engineers ≈ Accenture-outsourced-developer-in-SF* observation Evans makes. Evans (May 2026, independent-analyst altitude) reads the forward-deployed-engineer + consulting-investment pattern as **inside-the-AI-labs evidence that workflow-redesign needs humans**; Warren (June 2026, YC altitude) describes the **outside-the-AI-labs corollary** — startups building AI-native services companies that ship outcomes (not co-pilots) into the same workflow-redesign demand. The two sources together explain the *services-don't-disappear-they-reinvent* dynamic at three altitudes (Evans observer / Warren builder / Sternfels incumbent)."
    confidence: 0.7
  - type: supports
    target: 2026-04-24-hu-yc-how-to-build-a-company-with-ai-from-the-ground-up
    via: "Same-vantage twin on AI-native company-building, different category. Hu (April 2026, YC Partner altitude) argues *closed-loop AI-from-the-ground-up* as the AI-native software-product playbook — *intelligence layer at the centre of the company*, *queryable organisation*, *AI-founder-type as still-builds, still-coaches, leads-by-example*. Warren (June 2026, YC Visiting Partner altitude) writes the **services-company sibling** of Hu's playbook: same YC altitude, same *built-from-scratch on AI* core thesis, different category (services that sell outcomes, not software products). Together the two pieces form **YC's two-vertical AI-native-company curriculum**: Hu on AI-software products, Warren on AI-services companies. Convergent on operational rigor + founder fluency + process-as-product framings."
    confidence: 0.85
  - type: supports
    target: 2026-05-27-koomen-yc-lightcone-inside-yc-ai-playbook
    via: "Convergent at YC partner-altitude on the *AI-as-building-layer-for-everything* core thesis. Koomen (YC General Partner, May 2026) emphasises the YC-internal infrastructure side (multiplayer-harness primitive set, shared-tool-and-skill registry, the dream cycle). Warren (YC Visiting Partner, June 2026) emphasises the **outward-facing playbook** for founders building AI-native services companies that ride that same building-layer. Both reject the *AI-as-feature* framing in favour of *AI-as-foundation* — Koomen's *'AI as the building layer for everything, not a copilot'* line is the spiritual twin of Warren's *outcome vs co-pilot* distinction."
    confidence: 0.75
  - type: supports
    target: 2026-05-28-giles-wp-intelligence-new-human-machine-workforce-agentic-ai-jobs
    via: "Convergent on the **services-firms-rebuilt-with-AI-doing-most-of-the-work** macro frame. Giles (WP Intelligence, May 2026, executive-readership altitude) surfaces the McKinsey top-3 functions (IT / knowledge management / sales & marketing) where companies are ramping up agent use + the HubSpot Russell + IBM-entry-level redesign worked examples + the *humans-on-judgment-work, agents-on-execution-work* prescription. Warren (June 2026, YC altitude) describes the **vendor-startup category** building the agents the Giles enterprises are deploying. The wiki's first explicit cross-altitude pairing of *enterprise-buyer of agent services* (Giles) with *startup-vendor of agent services* (Warren) — same market viewed from both demand and supply sides."
    confidence: 0.65
  - type: supports
    target: 2026-05-27-scheffer-de-ondernemer-helloprint-ai-rebuild-from-day-zero
    via: "Convergent on the *built-from-scratch / day-zero rebuild* thesis at two scales. Scheffer (HelloPrint Dutch SME, May 2026, €80M revenue) executes the day-zero rebuild *inside an established firm* with the customer-service-100-to-18 worked example; Warren (June 2026, YC altitude) describes the day-zero rebuild *as a new-firm playbook* — *'companies … rebuilt from scratch with AI doing most of the work'*. Scheffer is the in-place rebuild at SME scale; Warren is the greenfield rebuild at startup scale. The two together name the same phenomenon at two boundary conditions. Both also reject the *AI-bolted-on-feature* alternative path."
    confidence: 0.7
  - type: supports
    target: 2026-05-28-moon-mckinsey-rewiring-software-delivery-for-the-agentic-era
    via: "Convergent on the *humans-as-interface-not-product + scale-nonlinearly + throughput-as-product-metric* operational discipline. Moon et al. / McKinsey (May 2026, McKinsey-Digital partner altitude) supply the same operational shape at the *inside-the-software-delivery-team* layer — *'human role less about producing artifacts and more about supervising and improving the system that produces them'*; the 100→60 FTE / 10-role-pod → 3-role-pod team-shape collapse. Warren (June 2026) writes the **AI-native-services-vendor analog** of the same operational shape: *'the human is the interface of the customer, not the product. The product helps the human scale their work nonlinearly. Throughput and cycle time are now product metrics. Track them like you would daily active users.'* Same operating-model shift, two industries (software delivery + professional services)."
    confidence: 0.7
---
...
(Channel description, [[Y Combinator|Y Combinator Startup School]], 3 June 2026.)

A ~11:23 short-form *Startup School* talk delivered by **Charlie Warren** — **YC Visiting Partner** — published on the [[Y Combinator]] YouTube channel on 3 June 2026. The wiki's **first YC source explicitly framing *AI-native services companies* as a distinct go-to-market category**, alongside the existing nine YC sources which all sit on the *AI-software product* side of the line ([[2024-04-18-caldwell-lennys-podcast-lessons-1000-yc-startups-tarpit-ideas|Caldwell]] / [[2026-02-25-akhtar-forget-yc-letter-ai-powered-revenue|Akhtar]] / [[2026-03-23-wu-an-yc-momentic-qa-layer-ai-coding-era|Wu & An / Momentic]] / [[2026-04-09-dinakaran-yc-luminai-automating-americas-biggest-hospitals|Dinakaran / Luminai]] / [[2026-04-23-tan-yc-how-to-make-claude-code-your-ai-engineering-team-gstack|Tan / GStack]] / [[2026-04-24-hu-yc-how-to-build-a-company-with-ai-from-the-ground-up|Hu]] / [[2026-04-25-masad-replit-ceo-only-two-jobs-left|Masad / Replit]] / [[2026-05-19-garg-yc-internal-ai-agent-evolves-itself|Garg]] / [[2026-05-27-koomen-yc-lightcone-inside-yc-ai-playbook|Koomen]]). With Warren, the YC source-count rises to **ten**, and the cluster now spans **two AI-native-company vertical curricula** — Hu on AI-software products from the ground up, Warren on AI-services companies from the ground up. The pieces are explicitly complementary; both reject *AI-as-feature* in favour of *AI-as-foundation*, but they apply that thesis to different vendor categories.
...
|---|---|---|
| **Low trust** | The work is already outsourced; the customer cares about the final product, not how they got there | *"You're displacing a vendor, not asking the customer to do something fundamentally different. That's a huge deal because you're not changing behavior. You're showing up where the budget already lives and doing the work."* |
| **Low judgment at the task level** | Break the work into pieces; most steps automatable; judgment focused in a few places where humans stay in the loop | If *every* piece needs a human exercising actual judgment, you can't scale |
| **High intelligence threshold** | The *overall* work has to be hard | Hard enough that models + humans are needed to deliver an outcome the customer accepts (*"this sounds contradictory, but actually it isn't"*) |
| **Regulation could actually be good** | Regulated industries have higher expectations and legal accountability | *"That raises the bar and the moat for founders"* — regulation is a **founder ally**, not an obstacle |
...
- **Variance is the existential problem.** *"By variance, I mean non-uniform outputs from your actual service. Customers will fire you for variance faster than they will fire you for being a bit slower or a bit more expensive than the incumbents. They need to trust the output. Inconsistency destroys trust, which causes churn."* The wiki's clearest single-source statement of *variance-not-cost-not-speed-as-the-customer-firing-trigger* in AI-services. This is the operational analogue of [[2026-05-15-osmani-agent-harness-engineering|Osmani's]] *ratchet-don't-brainstorm* AGENTS.md discipline applied at the service-delivery layer.
...
|---|---|---|
| **Per-unit pricing** | GO (per return / per claim / per loan) | *"The cleanest. The easiest to explain."* |
| **Outcome-based pricing** | GO (Panacea: priced on completed consultant study) | *"Aligns incentives beautifully, but can be harder to forecast in your business."* |
| **Cost-plus pricing** | AVOID | *"Caps your upside permanently. Don't do it."* |
| **Straight-line undercutting** | AVOID | *"Makes your work seem cheap and potentially low quality. Price on value."* |
...
- `digital-transforming/redesigning-internal-structures` — *humans-as-the-interface, the-product-is-an-operation, throughput-as-product-metric, humans-scale-nonlinearly* + the General Legal Team *shift-work* worked example.
- `digital-transforming/improving-digital-maturity` — the three founder attributes (domain + model + operational fluency).
- `strategic-renewal/business-model` — *outcome vs co-pilot* + 30%-services-margins → 50%+-AI-leveraged + TAMs-2-to-3×-bigger-than-software is the business-model-renewal claim.
