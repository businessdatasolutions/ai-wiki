...
type: source
kind: video
title: "Agentic AI: What Leaders Wish They Knew Sooner"
author: ["MIT Sloan Management Review"]
publisher: "MIT Sloan Management Review (YouTube); 2026 MIT Sloan CIO Symposium"
url: "https://www.youtube.com/watch?v=qekc7JNKix8"
date_published: 2026-06-11
date_ingested: 2026-06-15
length: "~11:28 minutes (transcript ~243 segments; manual English CC track, kind: manual)"
raw: "../../raw/videos/agentic-ai-what-leaders-wish-they-knew-sooner.md"
tags: [mit-smr, mit-sloan-cio-symposium, agentic-ai, human-in-the-loop, human-on-the-loop, performative-oversight, manage-agents-like-employees, micro-agents, trust-fabric, workflow-redesign, collaborators-not-competitors, automate-first, thomas-davenport, michael-schrage, keri-pearlson, max-chan, monica-caldas, multi-speaker-compilation]
...
relationships:
  - type: published-by
    ...
    via: "MIT SMR YouTube channel; filmed at the 2026 MIT Sloan CIO Symposium, hosted by EIC Abbie Lundberg"
  - type: contradicts
    target: 2026-05-06-kropp-bcg-hbr-dont-treat-ai-agents-like-employees
    via: "Swift & Chan argue *manage agents like employees* (check output, performance-monitor, lifecycle/end-of-life) vs Kropp/BCG's anti-anthropomorphising thesis that the employee metaphor misassigns accountability — partial: both agree humans stay accountable"
  - type: supports
    target: 2026-06-02-architecting-ai-native-organizations-redesign-work-at-scale-joe-beutler
    via: "human oversight at the right places + reimagine workflows for new outcomes (Caldas/Westerman echo Beutler's Ask→Assist→Automate maturity ladder)"
  - type: supports
    target: 2026-05-21-allen-aws-london-exec-forum-agentic-team-structures
    via: "humans-on-judgment / agents-on-execution + human-in-loop-at-the-seams; Schrage's in-loop-vs-on-loop sharpens Allen's human-starts-human-ends pattern"
  - type: supports
    target: 2026-06-12-argenti-hbr-thrive-alongside-ai-mindset-not-skillset
    via: "operator→supervisor role shift (Chan: replace yourself at the lower level, move up) + reimagine-not-just-automate (Westerman) ≈ Argenti's 3×-not-20% and operator→supervisor"
  - type: supports
...
2. **"Manage agents like employees" is a live, contested frame.** Swift and Chan argue *for* the employee metaphor (lifecycle, monitoring, re-prompting); the wiki's [[2026-05-06-kropp-bcg-hbr-dont-treat-ai-agents-like-employees|Kropp/BCG source]] argues *against* it (anthropomorphising misassigns accountability and invites *AI brain-fry*). Recorded as a typed `contradicts` edge — a genuine open debate, not a resolved one.
3. **Reimagine-don't-just-automate, again.** Westerman ("automate first, then humans in the right places"; rebuild for outcomes) and Caldas (reimagine the workflow, micro-agents, OKRs) restate the [[micro-productivity-trap]] escape at the same altitude as [[2026-06-12-argenti-hbr-thrive-alongside-ai-mindset-not-skillset|Argenti's]] *3×-not-20%*.

## Dynamic-capabilities (W&W) reading

- `digital-transforming/redesigning-internal-structures` + `improving-digital-maturity` — the dominant theme: redesigning workflows and roles around human+agent teams (Caldas's maturity arc, Westerman's rebuild-for-outcomes, Escrivá García's design/implement split).
- `digital-seizing/strategic-agility` — Razdan's test-experiment-learn-iterate and Caldas's entry/exit-criteria experimentation arc.
- `strategic-renewal/organizational-culture` — the cultural shift to *collaborators-not-competitors* (Shah), *combination/marriage* (Pearlson), and humans-learning-to-interact (Nagrecha).
- `contextual/internal-barriers` — Davenport's *humans won't want to be auditors* and the trust-building friction (Razdan, Nagrecha) are the human barriers to agentic adoption.
