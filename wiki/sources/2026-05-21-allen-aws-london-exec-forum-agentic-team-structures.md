...
**Authors / dangling list.** This is the first wiki source by both speakers; per the [author-entity promotion rule](../../CLAUDE.md) (second-source promotion), they go on the dangling list at this ingest and only get entity pages on a second citation:
...
- Is the **Singaporean Davos-2026 governance model** the dominant emerging framework, or do the EU AI Act / NIST AI RMF / UK AI assurance frameworks converge with it? Worth comparing once an ingestible source on the Singaporean model lands.
