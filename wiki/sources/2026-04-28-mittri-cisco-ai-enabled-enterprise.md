...
subtitle: "With the right foundation, AI can transform enterprises."
author: ["Virginia Wilson (editor)", "Nicola Crepaldi (publisher)"]
publisher: "MIT Technology Review Insights"
sponsor: "[[Cisco]]"
url: "https://www.technologyreview.com/insights/"
raw: "../../raw/reports/MITTRI_Cisco.pdf"
date_published: 2025
date_ingested: 2026-04-28
tags: [mittri, cisco, sponsored-research, ai-adoption, ai-readiness, ai-agents, ai-infrastructure, ai-security, manufacturing]
length: "8 pages"
---
...
1. **Strategy** — well-thought-out, clearly defined AI strategy aligned with business goals
2. **Infrastructure** — evaluate network capacity for AI workloads (compute, energy, data, security; reaccelerating private data center for data sovereignty)
3. **Data** — good quality, company-wide data; break down silos; AI tools to query unstructured data
4. **Governance** — strengthen data governance per local/global regulations; responsible AI; regular review of policies
5. **Culture and talent** — develop tomorrow's skills today; allay job-displacement fears; reward successful initiatives
...
That said, the **agent-transition framing (chatbot → agent → multi-agent)** is genuinely useful and reinforces what [[2026-04-28-ai-index-report-2025|AI Index 2025]] (RE-Bench, Salesforce Agentforce) and [[2026-04-28-mit-sloan-ai-maturity|MIT Sloan]] (Italgas DANA, Stage 3+ "exploring autonomous agents") said separately. With four sources now converging on agents as a near-term enterprise reality, [[ai-agents]] earns its own concept page.
...
- **Raw PDF (8 pp):** [report file](../../raw/reports/MITTRI_Cisco.pdf)
