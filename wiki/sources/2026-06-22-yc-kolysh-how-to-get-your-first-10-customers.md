...
length: "~13:46 minutes (transcript ~107 ASR segments; auto-generated transcript, light cleanup applied for proper nouns)"
raw: "../../raw/videos/how-to-get-your-first-10-customers.md"
tags: [y-combinator, startup-school, max-kolysh, founder-led-sales, first-10-customers, warm-network, doing-things-that-dont-scale, in-person-sales, conferences, founder-dinners, reddit-gtm, outbound, apollo, clay, linkedin, advice-framing, cold-email, happenstance, customer-discovery]
relationships:
  - type: supports
    target: 2026-04-09-dinakaran-yc-luminai-automating-americas-biggest-hospitals
    via: "Founder-led-sales-as-doctrine pair. Kolysh's YC-Startup-School playbook for the *first 10 customers* (warm network for 1–3; doing-things-that-don't-scale — fly out, Reddit DMs, founder dinners, advice-framing — for 4–10) is the generalised prescription whose enterprise-altitude worked example is Dinakaran/Luminai: *'you're selling a champion within that one institution'*, the LinkedIn-contact-scraping script, the warm-intro discipline, and the red-eyes-to-close cadence. Both reject cold-outbound-at-scale as the early-stage GTM motion and locate the founder's personal credibility as the thing being bought. Kolysh: *'the first 10 customers will likely not come from a tool. They're going to come from you.'*"
    confidence: 0.8
  - type: supports
    target: 2026-05-20-glasgow-campfire-erp-for-ai-revolution
    via: "Both name *founder-led sales survives the AI era* as doctrine. Glasgow/Campfire: *'I do really recommend founders to stay in the founder sales mode… offloading it to AI, offloading it to some AE… feels like let's just bring in a professional.'* Kolysh: the messy 4-to-10 phase works *'because you personally, the founder, are doing it'* — automation tools (Apollo, Clay, sequences) only start to matter once you have 10–20 quality customers. Same doctrine, two altitudes (AI-native ERP buying vs general YC early-stage GTM)."
    confidence: 0.75
---
...
The full ~14-minute transcript (auto-generated captions, light ASR cleanup for tool/product names — Apollo, Clay, Happenstance, Calendly). Chapter structure from the creator description preserved in the TL;DR. The full raw transcript is at [`raw/videos/how-to-get-your-first-10-customers.md`](../../raw/videos/how-to-get-your-first-10-customers.md).
