...
publisher: "Y Combinator (YC Root Access channel — The Breakdown series; Tom Blomfield and David Lieb interviewing Dominic Vitucci / Onshore)"
url: "https://www.youtube.com/watch?v=lfzm2SlhbM8"
date_published: 2026-03-07
date_ingested: 2026-05-21
length: "~33:56 minutes (auto-generated English captions; ASR-cleaned, 278 segments)"
raw: "../../raw/videos/this-is-the-next-industry-ai-will-disrupt.md"
tags: [onshore, dominic-vitucci, tom-blomfield, david-lieb, accounting-disruption, big-four-incumbent, tax-credit-automation, professional-services-pricing-flip, project-billing, hourly-billing, harvey, lora, ai-employment-effects, vertical-ai, wedge-strategy, customer-story, the-breakdown, y-combinator]
...
relationships:
  - type: supports
    ...
    via: "Onshore is the wiki's first **deep professional-services-industry-disruption anchor** that complements Tan & Hu's CS153 *forward-deployed-engineer wedge* prescription with a worked example *one industry deep*. Hu names the wedge pattern generically (Salient / Happy Robot / Reducto); Vitucci is the wedge-pattern told as a 20-something-CPA-leaves-Grant-Thornton story over 33 minutes. **Productive tension on *boil-the-ocean***: Tan-CS153 inverts the *don't boil the ocean* dictum (*'let's boil the ocean, you can do the work of 500 to 1000 people'*); Vitucci asserts the conservative version (*'the idea of trying to boil the ocean all at once is very challenging; it has been an incredible benefit for our business to be great at one thing really early'*). The wiki carries both — they are both defensible at different stages and the contradiction itself is informative."
  - type: supports
    target: 2026-05-20-glasgow-campfire-erp-for-ai-revolution
    via: "Twin **AI-native-vendor-disrupting-incumbent-service-business** anchors on the YC Root Access channel. Glasgow / Campfire competes with NetSuite for tech-company ERP; Vitucci / Onshore competes with the **Big Four (Deloitte / KPMG / EY / PwC) + top-20 firms (Grant Thornton et al.)** for corporate tax and (eventually) audit. Both articulate the same incumbent-defection mechanism: incumbents have **misaligned senior-partner incentives** that block AI investment (Glasgow's *AI-native safety inversion*; Vitucci's *senior-partner-3-years-from-retirement-won't-plow-money-into-AI*). Both founders began by selling-to-incumbents and pivoted to compete-with-incumbents (Glasgow implicitly from his Adobe ERP background; Vitucci explicitly after 2 years of *banging his head against the wall* selling AI software to accounting firms). Both arrive at **revenue-per-employee** as the killer comp (Campfire: implied 10× of NetSuite's per-employee revenue; Onshore: explicit *'$1M+ per employee at $100M ARR target — Deloitte / KPMG estimated at $100-150k per employee, an order of magnitude better'*)."
  - type: supports
    target: 2026-05-11-hill-vori-grocery-os-paper-and-fax
    via: "Twin **2026 founder-fireside on vertical AI-native operator** ingests on the YC Root Access channel, two months apart. Both founders work an industry vertical that is structurally hostile to AI investment for *misaligned-incentive* reasons (Vori: 220k+ independent grocers running on paper, pencil, fax — no in-house IT to deploy software; Onshore: Big 4 / top-20 senior partners whose pension and 3-5-year-runway-to-retirement makes AI investment a personal-financial-negative). Both arrive at **wedge-first** as the disciplined way in (Vori: inventory-reorder app; Onshore: R&D tax credit). Both name **fired-all-our-incumbent-customers / fired-all-our-accounting-firm-customers** as the pivot moment that unlocked the real opportunity."
  - type: contradicts
    target: 2026-05-20-tan-hu-stanford-cs153-ai-native-company-1000x-engineer
    via: "Direct *boil-the-ocean* contradiction. Tan-CS153 names *boil-the-ocean* as the pro-AI inversion of conservative business advice (*'let's boil the ocean — you can do the work of 500 to 1000 people'*); Vitucci-Onshore names *don't-boil-the-ocean* as the disciplined survival strategy (*'the idea of trying to boil the ocean all at once is very challenging; we can come and show we can do an R&D tax credit better, faster, more affordably with better traceability — it's way better than showing up saying we can do all your stuff'*). Both are right at different stages: pre-revenue capability-claim (*how much can one engineer ship?*) vs revenue-stage wedge-discipline (*how do you win one CFO conversation against the Big 4?*). The wiki carries the disagreement explicitly — there is no synthesis that makes them agree, and the productive read is that Tan and Vitucci are arguing about different things."
---
...
1. **The structural-incentive-not-intent argument for incumbent blocking** — Big 4 firms aren't *resisting AI on the merits*; their senior-partner economics make AI investment a personal-financial-negative regardless of the business-merit case. This is the **incumbent-defection-by-structural-incentive** mechanism that complements [[2026-05-20-glasgow-campfire-erp-for-ai-revolution|Glasgow / Campfire]]'s *AI-native safety inversion* (which is the buyer-side mechanism that gives AI-native vendors *air cover*).
2. **The "you must compete with, not sell to, professional-services firms" doctrine** — same conclusion [[2026-05-20-glasgow-campfire-erp-for-ai-revolution|Glasgow]] reached independently for ERP; Vitucci reaches it for accounting after two years of failed sell-to-firm attempts.
...
The **boil-the-ocean tension with [[2026-05-20-tan-hu-stanford-cs153-ai-native-company-1000x-engineer|Tan-CS153]]** is captured as a typed `contradicts` relationship — not because either source is wrong, but because the wiki should record that **the productive 2026 founder doctrine carries opposite directional advice depending on stage**: at the engineering-capability level *boil the ocean* is the inversion of legacy *don't boil the ocean* business advice (Tan); at the wedge-into-an-industry-go-to-market level *be great at one thing really early* and don't try to do everything (Vitucci). Both are right at different altitudes.
...
- **Tom Blomfield** — already on the [[Y Combinator]] entity-page Dangling list from [[2026-05-19-garg-yc-internal-ai-agent-evolves-itself|Garg 2026]]'s reference to *"Pete and Tom and Gary"*; this is the **second substantive-source mention by full name (Tom Blomfield)** — promotable to an entity page in a follow-up ingest. Vitucci-channel-description names him as ex-Monzo / GoCardless founder.
...
- [[concepts/ai-employment-effects]] — major update opportunity: Vitucci's *Big-4 industry revenue up, headcount roughly flat, revenue-per-employee 10×* prediction is the wiki's most-specific articulation of the *substitution-without-elimination* pattern at industry-altitude. Tom Blomfield's *"five to six to seven years to come"* employment-rate-impact-lag prediction is the wiki's first explicit founder-vantage on the *capability-recognition-precedes-employment-effect* time-lag.
- [[concepts/automation-vs-augmentation]] — the *Big 4 firm of the future* shape (small senior partners / regulatory-expertise layer / software engineers + agents doing the work) is the wiki's first articulation of **augmentation at the senior-tier persisting while automation collapses the junior tier**.
- [[concepts/enterprise-ai-adoption]] — adds the *sell-to-firm fails because of misaligned senior-partner incentives + compete-with-firm succeeds* mechanism, with Vitucci's two-year worked example as the empirical anchor.
- [[concepts/ai-deskilling]] / [[concepts/durable-skills]] — *Lora/Harvey crack legal because lawyers are forward-thinking + already moved to project-based billing* gives the wiki two variables (industry forward-thinking-ness + billing-model maturity) that predict adoption velocity. The *"durable skill"* claim flips here — the durable skill in accounting is *not* expertise (which the AI can match or exceed at junior-mid level today) but **sales, regulatory-compliance positioning, and software engineering** — the three layers Vitucci names as remaining in his future-accounting-firm.

## Source quality

- **Channel**: [[Y Combinator|YC Root Access]] — *The Breakdown* series; analytical conversational format (vs Founder Firesides interview format).
