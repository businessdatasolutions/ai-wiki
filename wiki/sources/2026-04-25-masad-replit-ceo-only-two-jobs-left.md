...
type: source
kind: video
title: "Replit's CEO On The Only Two Jobs Left In The Company Of The Future — Amjad Masad at YC Founder Firesides"
author: ["Y Combinator"]
url: "https://www.youtube.com/watch?v=kMYeTRqzAfc"
date_published: 2026-04-25
length: "~39:08 minutes (transcript ~382 ASR lines)"
raw: "../../raw/videos/masad-replit-ceo-only-two-jobs-left.md"
tags: [vibe-coding, replit, amjad-masad, ai-native-companies, agent-platform, parallel-agents, founder-firesides, yc, company-of-the-future, builders-and-salespeople, vibe-coding-resident, post-prompting, computer-use-agents, continual-learning, durable-skills, ai-employment-effects, strategic-renewal, enterprise-ai-adoption]
...
relationships:
  - type: supports
    target: vibe-coding
    via: "Masad/Replit was the first commercial vibe-coding *product* (September 2024 abstraction of code behind natural language); validates Karpathy's later December-2025 phase-change framing with the platform vantage and a CEO-level account of the AI-native-builder cohort taking over the product"
  - type: supports
    target: ai-employment-effects
    via: "'The company of the future is made of builders and salespeople' — a concrete employment-future thesis from a vendor-CEO building the infrastructure that would enable it; pairs with the wiki's existing automation-vs-augmentation and durable-skills clusters"
  - type: supports
    target: enterprise-ai-adoption
    via: "vibe-coding-resident team as an internal-structure pattern: a generalist team with vague mission ('go around the company and make it better') deputising agents to solve concrete bottlenecks (support queue prioritisation, HR onboarding tooling)"
  - type: supports
    target: agentic-engineering
    via: "Masad's six-month-step-change product cadence (each Agent N release synchronises Replit's platform to the next AI capability step) is an explicit external-triggers-driven roadmap structure; the Agent 4 launch couples parallel agents + canvas-design + multi-modality into a single release"
  - type: supports
    target: durable-skills
    via: "Masad's prescriptive 'skills that matter now' list (idea generation, taste, not-giving-up, playing-with-tools, being-online) operationalises the durable-skills frame at the level of individual posture for the AI-native-builder economy"
  - type: supports
    target: 2026-04-24-hu-yc-how-to-build-a-company-with-ai-from-the-ground-up
    via: "directly extends Hu's 'everyone builds and ops support sales' YC-batch thesis with the platform-vendor vantage: Replit's internal vibe-coding-resident team is the worked example of Hu's organisational pattern"
  - type: supports
    target: 2026-04-23-tan-yc-how-to-make-claude-code-your-ai-engineering-team-gstack
    via: "Masad's 'post-prompting' / high-level-goal product direction parallels Tan's adversarial-review-as-skill packaging; both are platform-level moves to package the AI-native workflow into reusable primitives"
---
...
3. **Agent 4 = parallel agents + canvas + multi-modality + skills-call**. The Agent 4 launch (April 2026, contemporary with the interview) packages four capabilities into a single release:
   ...
   - **Skills-call revolution** — Replit's MCP-and-integration layer: *"as you're talking to Replit and you're like 'I want to integrate Stripe', we already built a set of skills and sometimes code... it's sort of like Neo in the Matrix where you download a new skill and you're like, 'Oh, I know how to fly a helicopter now.'"* The skills-call framing parallels [[2026-04-23-tan-yc-how-to-make-claude-code-your-ai-engineering-team-gstack|Tan's GStack]] packaging at YC scale.

4. **The company-of-the-future is made of builders and salespeople** (37:00–end). The interview's headline:
...
1. **Predictive over-build**: Agent 3 was *"the most autonomous agent on the market"* in September 2025 when *"true autonomy didn't arrive until like November / December"* — the platform had to ship the long-running-container infrastructure ~3 months before the model side was ready. This is **contextual/external-triggers-driven roadmapping** in its strongest form: the platform commits capital to capability bets *before* the capability lands.
2. **Risk of mis-timed bets**: Computer-use agents are a *"mystery"* — Masad expected them to mature faster (*"if we can make progress on self-driving, surely we can make progress on moving the mouse"*). The wiki should track whether the bi-annual cadence holds or breaks.

## Convergence with the wiki's existing corpus

| Source | What it adds relative to Masad |
|---|---|
| [[2026-04-29-andrej-karpathy-from-vibe-coding-to-agentic-engineering\|Karpathy at Sequoia AI Ascent]] | The **coined term** and the December-2025 phase-change. Masad provides the **product-launch anchor** (September 2024) that predates Karpathy's framing by ~3 months on the platform side. Read together: Karpathy named what Masad shipped |
| [[2025-12-01-marily-nika-pms-who-use-ai-will-replace-those-who-dont\|Nika 2025]] | The **PM-side worked example**. Masad generalises the audience claim from *PMs* to *all tech-adjacent non-developers* + domain experts. Together they establish a **floor-raising audience pipeline** from individual PM workflow → cross-functional non-developer audience |
| [[2026-04-23-tan-yc-how-to-make-claude-code-your-ai-engineering-team-gstack\|Tan / GStack]] | YC-president-level worked example of vibe-coding-with-discipline. Masad provides the **platform-vendor parallel**: skills-call revolution = GStack-style packaging at the Replit-platform layer |
| [[2026-04-24-hu-yc-how-to-build-a-company-with-ai-from-the-ground-up\|Hu / Startup School]] | YC-partner-level prescription (*"everyone builds and ops support sales"*; closed-loop companies; software factories). Masad gives the **founder/CEO-vantage worked example** of Hu's structure: Replit's internal vibe-coding-resident team is *literally* the closed-loop pattern in operation |
| [[2025-05-06-jassy-amazon-agility-ai-strategy-changing-role-of-managers\|Jassy May 2025]] | Pre-coinage CEO anchor for the floor-raising thesis. Masad's *"so much software to build in the world... when anyone can make software, a lot of parts of the economy is just going to improve"* operationalises Jassy's prediction with a vendor doing the building |
| [[2026-04-14-thompson-the-daily-workers-letting-ai-do-their-jobs\|Thompson / The Daily]] | 75-developer survey anchor at small-startup (~100% AI-written) and Google (~40–50%) scales. Masad gives the **platform-side cross-audience anchor**: Replit's users are not the developers Thompson surveyed — they're physical therapists, pool-business owners, sports-club ops |
| [[concepts/vibe-coding\|vibe-coding]] concept page | This source adds: (a) the platform-launch date anchor; (b) the *anti-developer-bias* design observation; (c) the *post-prompting* product direction; (d) the vibe-coding-resident team as a worked organisational pattern |
...
- **The "computer-use agent mystery"**. Masad expected computer use to mature faster than language; it hasn't. This is a candidate for the wiki's open-questions cluster — paired with the [[2026-03-20-huggingface-agentic-evaluations-workshop|HF agentic-evals workshop]]'s sim-to-real-gap discussion, it suggests the bottleneck is *environment representation*, not raw capability.
- **Will the vibe-coding-resident pattern generalise beyond Replit?** Masad describes it as a normal internal team structure. The wiki should track whether [[2026-04-24-hu-yc-how-to-build-a-company-with-ai-from-the-ground-up|Hu]]'s YC-batch is seeing this pattern propagate — second sources documenting the *generalist-entrepreneur-inside-a-bigger-company* role at non-Replit firms would close the loop.
- **Post-prompting at scale**. Masad: *"I think we're headed to a post-prompting world... at some point perhaps Agent 5 or maybe sooner, you should be able to tell Replit 'every day build me a SaaS company and try to market it and see what works.'"* If post-prompting becomes the platform mode, the eval discipline (cf. [[2025-09-28-husain-ai-evaluations-clearly-explained-50-min|Husain]] and [[2026-03-20-huggingface-agentic-evaluations-workshop|HF Agentic Evals]]) becomes more critical, not less — the wiki should track whether the eval-as-offense framing scales to the post-prompting layer.
...
- [[concepts/vibe-coding]] — concept page this source materially extends with platform-launch date, audience refinement, and post-prompting direction.
- [[concepts/ai-employment-effects]] — concept page that the *builders-and-salespeople* thesis directly addresses.
- [[concepts/durable-skills]] — concept page that Masad's skills-that-matter list operationalises at individual-posture level.
