...
publisher: "Y Combinator (YC Root Access channel — founder fireside / Andrew Tan interview)"
url: "https://www.youtube.com/watch?v=X1NXnLRNIfM"
date_published: 2026-05-20
date_ingested: 2026-05-21
length: "~27:38 minutes (auto-generated English captions, ASR-cleaned, 221 segments)"
raw: "../../raw/videos/2026-05-20-glasgow-campfire-erp-for-ai-revolution.md"
tags: [campfire, john-glasgow, andrew-tan, y-combinator, yc-s23, ai-native-erp, enterprise-software, netsuite, quickbooks, brex, mercury, accel, ribbit-capital, founder-led-sales, product-velocity, wedge-strategy, build-vs-buy, foundation-models, agent-platform, vendor-displacement, enterprise-ai-adoption, customer-story]
...
relationships:
  - type: supports
    ...
    via: "Nishar & Nohria predict the buyer-side firm-boundary shift under GenAI — the build/compose/collaborate/buy framework dissolving one-size-fits-all enterprise software at a faster pace than the authors themselves predicted in 2025. Glasgow provides the **AI-native-vendor-side worked example with hard empirical anchors**: >100 customers pulled off NetSuite, more than doubled ARR each quarter since Q4 2024, single seed-stage business winning two-year contracts against incumbents that signed *'longer than your runway'* deals. The HBR / HBS-research lens names the macro shift; Glasgow names what that shift looks like from the AI-native vendor's procurement-room vantage."
  - type: supports
    target: 2026-04-24-hu-yc-how-to-build-a-company-with-ai-from-the-ground-up
    via: "Hu's AI-native-from-day-one + incumbent maintain-while-unwinding-constraint thesis (same YC channel, ~4 weeks earlier) framed the systemic vantage; Glasgow is the **vendor-side founder-CEO worked example** on the same axis. Campfire is the AI-native ERP that won enterprise migrations because incumbents could not unwind their legacy stack into an AI-native posture fast enough. Glasgow's *'own foundation model + custom agent platform'* claim is the company-stack instantiation of Hu's *'intelligence layer'* framing."
  - type: supports
    target: 2026-05-13-jha-emergent-democratizing-app-building-with-claude
    via: "Paired 2026 founder-CEO anchors on the **AI-native-vendor advantage**, from opposite ends of the customer-size spectrum. Jha names it as adoption-velocity-asymmetry-favouring-the-long-tail (SMB / domain-expert / non-developer); Glasgow names it as **enterprise-safety-inversion** (board-level procurement shift — *legacy = not-AI-native = risky*; AI-native gets the *air cover* that legacy used to enjoy). Same vendor-side phenomenon — *being AI-native is no longer the disadvantage it was; being legacy is now the disadvantage* — observed independently in two product categories (natural-language-to-app vs AI-native ERP) at the same moment in 2026."
---
...
A ~27:38 founder fireside on the [[Y Combinator|YC Root Access]] channel, published 2026-05-20. **[[Andrew Tan]]** (YC partner; ex-CTO at [[PagerDuty]]) interviews **[[John Glasgow]]**, CEO and founder of **[[Campfire]]** — a YC S23 AI-native ERP platform that has, since Q4 2024, doubled ARR every quarter while pulling enterprise customers off [[NetSuite]].
...
- **Tech-stack-turnover argument for the "why now"** (~22:44–23:18): everything in the finance tech stack — payroll, spend management with the [[Brex|Brexes of the world]] — had turned over in the last 5–10 years *except the core general ledger*. The contrast made a finance person logging into a modern spend-management tool and then the ERP feel *"very acute,"* prompting them to seek out the modern alternative.
...
**Caveats.** The transcript is auto-generated and ASR-cleaned, not human-curated. Glasgow is the company's founder-CEO speaking on a YC marketing channel — every substantive claim is filtered through obvious commercial incentives (talent recruiting, customer acquisition, future-round signalling). The empirical anchors (>100 customers, doubled ARR/quarter since Q4 2024) are concrete and falsifiable but unaudited in this venue. The "AI-native safety inversion" thesis is named here from a single vendor-side vantage; it pairs with [[2026-05-13-jha-emergent-democratizing-app-building-with-claude|Jha/Emergent]]'s independent observation of the same vendor-side shift in a different product category, which is what raises this beyond a single-source curiosity.
...
1. **HBS / HBR research vantage** — [[2026-05-05-nishar-nohria-end-of-one-size-fits-all|Nishar & Nohria 2026]] frame the *firm-boundary shift* under GenAI as a four-model collapse of one-size-fits-all enterprise software (build / compose / collaborate / buy outcomes). Their thesis is buyer-side and macro.
2. **AI-native company-building doctrine** — [[2026-04-24-hu-yc-how-to-build-a-company-with-ai-from-the-ground-up|Hu/YC]] (same channel, ~4 weeks earlier) names the *AI-native-from-day-one* advantage as a structural constraint legacy incumbents cannot unwind on the relevant timescale. Hu's thesis is supply-side and systemic.
3. **Consumer / SMB / long-tail founder vantage** — [[2026-05-13-jha-emergent-democratizing-app-building-with-claude|Jha/Emergent]] (one week earlier; ingested in the Claude-channel customer-story batch) names the same vendor-side flip at the *adoption-velocity-asymmetry-favouring-the-long-tail* end: $100M ARR in 8 months serving 7M users in 190 countries, 70–80% of whom never wrote a line of code.
...
1. **It is a narrative flip, not a feature flip.** Campfire had AI features earlier ("we had AI pretty quickly" ~23:43); what changed between mid-2024 and mid-2026 was *what the board would underwrite as a safe choice*. The shift is on the procurement-decision-maker's side, not on the product side.
2. **The shift moves through the C-suite / board / auditor channel, not the day-to-day operator channel.** *"Even if the accountant wasn't fully ready to embrace AI, they had this blessing"* — the [[concepts/ai-employment-effects|day-to-day operator's]] hesitancy is overruled, not converted.
3. **The narrative had to shift even though the core product didn't.** *"Your narrative needs to continue to shift even if the core product ultimately, you know, ends up not shifting"* (~24:50–24:59).

This is a different shape of buyer-side shift than the slow-organisation-adoption framing in much of [[concepts/enterprise-ai-adoption|enterprise-ai-adoption]]: it is **fast at the procurement layer**, **slow at the operator layer**, and the fast-procurement layer overrides the slow-operator layer because the board explicitly authorises it.
...
Two things worth filing for the wiki: (a) the explicit *don't offload to AI* discipline is a counter-claim against the most aggressive *agents-everywhere* narratives — relevant to [[concepts/automation-vs-augmentation|automation-vs-augmentation]] as a vendor-CEO-stated boundary; (b) the *sales-team-driving-engineering* feedback loop is the (un-named) operating logic behind why founder-led sales produces the *product velocity* customers later cited as a trust signal.
...
The wiki-relevant pattern: *forward-looking build-pace as the procurement-side substitute for present feature parity.* This is consistent with the [[2026-05-13-jha-emergent-democratizing-app-building-with-claude|Emergent]] customer-story-cluster pattern of *velocity as the feature*, but Glasgow names it specifically as the **enterprise-buyer's trust mechanism** when the vendor is seed-stage. To this day, *"we've never had anybody outgrow Campfire"* (~10:39).

### Own foundation model + custom agent platform as moat

Brief but load-bearing for the [[concepts/agent-harness|agent-harness]] cluster (~17:47–17:54):
...
1. **A custom foundation model** — Campfire is not just a thin wrapper on a frontier-lab API; Glasgow claims a vertical model for the finance/accounting domain.
2. **A custom agent platform** — Campfire's own harness over that model, not someone else's.
3. **A competitive-moat reading** of (1)+(2) — "the only one" — implicitly contra a hypothesised cohort of AI-native-ERP peers that wrap general-purpose models without a vertical foundation-model investment.

The claim is too lightly anchored in this source alone to ratify into the [[concepts/foundation-models|foundation-models]] or [[concepts/agent-harness|agent-harness]] concept page as a substantive convergence — but it is a **vendor-side empirical data point** that aligns with the *harness-as-moat* thesis already named on those concept pages by other practitioner anchors (Lopopolo, Jha, Fung, Osmani). Filed as a one-line addition to agent-harness's enterprise-vertical-vendor cluster.
...
**Concepts touched** (existing): [[concepts/enterprise-ai-adoption|enterprise-ai-adoption]] (substantive — new vendor-side enterprise-procurement-flip vantage), [[concepts/automation-vs-augmentation|automation-vs-augmentation]] (modest — Glasgow's *automate manual work → focus on more strategic work* framing for finance teams + his founder-led-sales boundary against *offloading to AI*), [[concepts/agent-harness|agent-harness]] (modest — vendor-vertical own-foundation-model + custom-agent-platform data point).
...
- **Is the "AI-native safety inversion" reproducible across categories beyond finance?** Glasgow names finance specifically and ties the inflection to *Q4 2024 / "a year and a half ago"* (relative to 2026-05-20). A future ingest could either ratify or contest this across HRIS, CRM, ATS, and other classical enterprise-SaaS categories. The Jha/Emergent pairing suggests *yes* on the long-tail end; the [[2026-05-05-nishar-nohria-end-of-one-size-fits-all|Nishar & Nohria]] framework suggests *yes* on the macro buyer-side; the missing piece is direct vendor-side founder testimony from another enterprise-B2B category.
