---
type: synthesis
aliases: ["strategy finite vs infinite game", "Sinek Martin tension synthesis", "infinite-game strategy synthesis"]
tags: [strategy, infinite-game, finite-game, sinek, martin, oberholzer-gee, theory-of-winning, value-stick, theory-based-view, strategic-foresight, dynamic-capabilities, systems-thinking, productive-tension, cross-lens, synthesis]
derived_from: [strategy-finite-vs-infinite-game]
opened: 2026-05-18
closed: 2026-05-18
confidence: 0.75
...
relationships:
  - type: supports
    target: strategy
    via: "this synthesis resolves the finite-vs-infinite-game tension flagged on the strategy concept page §Debates and supersession into a layered-difference reading rather than a contradiction"
  - type: supports
    target: infinite-game
    via: "the cross-walk in the Findings section is the canonical reference for how the infinite-game frame relates to the wiki's other strategy lenses"
  - type: supports
    target: theory-based-view
    via: "the synthesis treats TBV as the falsifiability layer that disciplines both Martin's *theory of winning* and Sinek's *Just Cause* — same construct at different rhetorical altitudes"
quality_score: 1
---

# Synthesis: Strategy — Finite-Game vs Infinite-Game (a layered difference, not a contradiction)

Closes [[threads/strategy-finite-vs-infinite-game|strategy-finite-vs-infinite-game]]. Filed 2026-05-18.
...
1. **Game-frame layer** (highest abstraction): *what game am I playing — finite or infinite?* [[infinite-game|Sinek/Carse]] sits here. The Just Cause is a *theory of why the institution should perpetuate itself*.
2. **Theory-of-winning layer** (middle): *given the game, what is my theory of how to win the rounds?* [[2022-06-29-martin-hbr-a-plan-is-not-a-strategy|Martin 2022]]'s *integrative set of choices with a theory of winning* sits here. [[theory-based-view|TBV]] is the falsifiability discipline applied to this layer.
3. **Value-creation-instrument layer** (most concrete): *given the theory, what am I optimising round-by-round?* [[2022-02-23-oberholzer-gee-hbr-what-is-strategy-value-stick|Oberholzer-Gee 2022]]'s value stick (WTP / WTS) sits here.
...
- **Martin — *theory of winning* ([[2022-06-29-martin-hbr-a-plan-is-not-a-strategy|Martin 2022]])** — **productive tension on Southwest, alignment in structure.** Martin's *strategy is a journey — a mechanism for tweaking it, honing it, refining it* converges on Sinek's *competing only against yourself* once the layer-difference is named. The Southwest tension persists because Martin's vocabulary is finite-game ("a smaller pie left over") while the durable performance Martin describes is infinite-game. The cleanest reading: Martin uses finite-game vocabulary to describe an infinite-game outcome.
- **Oberholzer-Gee — value stick ([[2022-02-23-oberholzer-gee-hbr-what-is-strategy-value-stick|Oberholzer-Gee 2022]])** — **alignment.** The *make the job a better job, don't just pay more* move is structurally Sinek's *Trusting Teams* element in economic vocabulary. Best Buy's store-in-a-store WTS-reduction is *infinite-game investment in the institution against its previous self*. And *value creation precedes value capture* is Sinek's *Just Cause above metrics* restated economically.
- **[[theory-based-view|Felin & Zenger — TBV]] (via [[2026-04-28-carroll-sorensen-strategy-analogy|Carroll & Sørensen 2024]])** — **alignment.** TBV's *novel / simple / elegant / falsifiable / generative* criteria are the falsifiability hygiene applied to the Just Cause. *"Who must you convince for your theory to be realized?"* (TBV's fourth question) is Courageous Leadership reframed as coalition-building.
- **[[analogical-reasoning|Disciplined analogy]] ([[2026-04-28-carroll-sorensen-strategy-analogy|Carroll & Sørensen 2024]])** — **orthogonal.** Methodology for strategy formation, not a strategy definition. The lenses operate at different layers and do not compete.
- **[[strategic-foresight|Strategic foresight reunion]] ([[2026-04-28-webb-strategic-foresight|Webb 2024]])** — **alignment.** Webb's *"organisational resiliency in the face of unforeseen disruption"* is operationally Sinek's *Existential Flexibility* element (element 5) under a different vocabulary. The FTSG 10-step methodology supplies the process discipline Sinek's framework lacks.
- **[[2026-03-31-carrier-mit-industrial-ai-that-works-strategy-survival-success|Carrier 2026]] — adoption speed** — **partial rhetorical tension.** Carrier's *"winners will be determined by adoption speed"* sounds finite-game ("winners"), but the substrate — *"changed the way the work is done, not simply improve the workflow"* and Heineken Mexico's compounding monthly capacity gains — is infinite-game: the institution becoming a better version of itself.
- **[[systems-thinking|Strategy as journey under feedback]] ([[2026-05-15-sterman-systems-thinking-for-leaders-designing-solutions-that-work|Sterman 2026]])** — **strong alignment.** The wiki already carries `[[2018-05-31-sinek-nyt-the-infinite-game|Sinek]] supports [[2026-05-15-sterman-systems-thinking-for-leaders-designing-solutions-that-work|Sterman]]` via *"Sinek motivates from leadership; Sterman from feedback dynamics."* Different vocabularies (leadership mindset / feedback loops / strategic theory under revision), one operational stance: *the game does not end; the strategy is a long-running loop.*
- **[[dynamic-capabilities|Dynamic capabilities]] (Teece) as strategy substrate** — **alignment.** *Sense / seize / transform* is structurally an infinite-game capability profile — it has no terminal state. Sinek's Existential Flexibility is *transform* under another name; Worthy Rival is *sense* under another name (a rival you watch to learn rather than to defeat).
- **Sinek's infinite-game as a strategy definition in its own right** — **the layered-frame contribution.** Read at this altitude: *strategy is the set of integrative choices that perpetuates the institution's pursuit of its Just Cause.* The wiki holds this as the **game-frame layer**, complementary to Martin's theory-of-winning layer and Oberholzer-Gee's value-creation-instrument layer.
...
- **Value capture vs value creation as starting point** ([[concepts/strategy|strategy]] §Debates). Oberholzer-Gee insists value creation precedes value capture; the financial-targets-first tradition disagrees. The infinite-game frame leans Oberholzer-Gee's way (a Just Cause is upstream of a financial target) but doesn't resolve the operational question of which framing to *start* with.
- **Whose WTP measured under agent-as-buyer dynamics?** ([[concepts/strategy|strategy]] §Open questions, with [[2026-05-11-ognibeni-ai-agents-cool-demos-vs-real-revenue-china|Ognibeni 2026]] and [[2026-05-14-price-dfi-retail-asia-reinventing-how-it-sells|Price 2026]] as the candidate primary sources). Carries forward.
...
- **Sinek 2019 book *The Infinite Game***. Deferred-ingest (Phase B3 of the strategy-gap remediation plan). Landing would lift [[infinite-game|infinite-game]] from `source_count: 1` to `source_count: 2` and ratify (or qualify) the cross-walk above. Worth a re-read of this synthesis after B3 lands.
...
- **Value-capture-vs-value-creation as starting point** and **whose-WTP under agent-as-buyer dynamics** — both carry forward from [[concepts/strategy|strategy]]'s own open-question list; this synthesis does not adjudicate either.
