...
### The bottom-up/top-down complementarity + the coming data rearchitecture ([[2026-06-17-ng-langchain-interrupt-future-of-ai-agents|Ng / LangChain Interrupt 2026]])

[[2026-06-17-ng-langchain-interrupt-future-of-ai-agents|Andrew Ng]], reporting from **AI Aspire**'s advisory work with Fortune-50/G2000 firms, supplies a sharp practitioner diagnosis that converges with the [[micro-productivity-trap]] and the [[2026-06-18-dumra-mit-smr-dbs-everyone-an-innovator|DBS]] playbook:
...
## The adoption-vs-capability lag + the workforce-strategy CEO playbook ([[2026-04-03-bcg-emerson-kropp-ai-will-reshape-more-jobs-than-it-replaces|BCG / Emerson, Kropp et al. 2026]])
...
## The back-office-first deployment sequence + trust-speed adoption model ([[2026-06-17-priest-atlantic-pwc-ai-agents-changing-business|Priest / PwC, June 2026]])

Dan Priest, PwC's Chief AI Officer, supplies a concrete **deployment sequence**: code generation ("the number one most industrialized use case") led from the back office, benefits then propagated to front-office customer service, and adoption is now moving into the **middle office** — "probably the least penetrated." PwC's own Southwest Airlines case study: 50% of time/effort cut from the *design* phase alone (before any code generation), 30–50% benefits once code generation is applied. Two adoption-speed claims worth flagging: **(a)** developer headcount and recruiting are *rising* even as CS enrollment falls — Priest reads this as evidence against wholesale developer displacement; **(b)** citing an unlinked Stanford trust survey, Priest frames adoption speed as gated by *national trust* that AI is net-positive for humanity (~80% China/UAE vs. ~40% US) more than by technology maturity — *"adoption and AI value realization will move at the speed of trust."* This trust-speed claim is a `contextual/external-triggers`-adjacent framing not previously present in the wiki's adoption material; it complements rather than displaces the [[micro-productivity-trap]] and maturity-stage models above, which explain adoption *depth* rather than adoption *speed*.

## Reinvention over productivity: why AI-driven efficiency gets competed away ([[2026-07-09-catlin-mckinsey-podcast-real-ai-advantage|Catlin / McKinsey Podcast, July 2026]])

Tanguy Catlin (McKinsey Senior Partner, MGI Director) supplies the sharpest single articulation in the wiki's corpus of *why* the [[micro-productivity-trap]] happens at the competitive-strategy level, not just the organizational-execution level: because AI is a general-purpose technology available to every competitor, the "first reflex" — deploying AI on top of existing processes to extract efficiency — produces productivity gains that get **competed away**, with the surplus flowing to customers and suppliers rather than accruing to the deploying firm. Every prior general-purpose technology has followed this pattern. Catlin's prescription, explicitly naming **[[2026-05-03-rewired-second-edition-sample|*Rewired*]]**: pick a domain, don't bolt AI onto existing processes, *redesign* the process to capture the technology's value, make the redesign scalable, then expand. He adds a three-lever theory of where durable advantage will actually come from — **proprietary data** (cheap AI predictions raise the marginal value of exclusive data used to generate them), **habit-embedding** (locking in via platform/product integration), and **"metabolic rate of learning"** (the speed of a self-reinforcing experiment→insight→better-offering loop) — and names the **organizational/people lens** (vs. strategy or technology) as the hardest of the three CEO-facing dimensions, because adaptation requires a genuinely upskilled, confident workforce and management systems that reward experimentation over punishing failure — not just tool access.
...
- **Equalizing effect persistence.** Robust in early studies. Open question: as AI tools mature, do high-skill workers eventually catch up by leveraging more sophisticated workflows? Or does the effect deepen as agents handle more of what high-skill humans currently do? [[2026-06-17-priest-atlantic-pwc-ai-agents-changing-business|Priest (PwC, June 2026)]] reports a data point on the "catch up" side: across coding and (anecdotally) music-making, "the best talent gets the most from AI" — the inverse of the equalizing effect. Anecdotal practitioner testimony, not a controlled study, but a live signal that the equalizing effect may be task-complexity-dependent rather than universal — see [[automation-vs-augmentation]]'s Debates and supersession for the fuller discussion.
...
### Interaction-design as the lever — the four-parameter framework + the negative-untailored finding ([[2025-06-09-krakowski-human-centered-ai-field-experiment|Krakowski et al. 2025 (Management Science)]])

Where most adoption frameworks in this concept page operate at the *deployment-decision* layer (where to use AI, which capabilities to deploy, which stage to be in), [[2025-06-09-krakowski-human-centered-ai-field-experiment|Krakowski et al.]] move one layer down to the **within-deployment interaction-design** layer. Their N=72 Nordic pharma sales experts DiD field experiment shows: holding the AI system constant, *the configuration of work procedure, decision authority, training, and incentives* — tailored to individual cognitive style per [Kirton 1976](Kirton) — is what determines whether the deployment is value-creating or value-destroying. **Untailored deployment causes market share to gradually *decline* vs a stable legacy-IT baseline**, with utilization in the untailored condition also gradually decreasing as sales experts withdraw from the system. The wiki's first academic-RCT-grade evidence that **deployment alone is not the lever; interaction-design is**. Pairs structurally with [[2026-05-06-kropp-bcg-hbr-dont-treat-ai-agents-like-employees|Kropp et al.]]'s finding (the same year) that the *framing* of AI in the org (tool vs employee) also matters at the interaction-design layer — both papers argue **the apparently-administrative organisational-design choices around AI deployment are causally consequential**.

### The anti-anthropomorphizing-AI prescription at consultant altitude ([[2026-05-06-kropp-bcg-hbr-dont-treat-ai-agents-like-employees|Kropp et al. / BCG Henderson Institute, HBR May 2026]])
