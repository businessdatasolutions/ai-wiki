...
## The AI Layoff Trap: a game-theoretic model for why competitive markets could force over-automation ([[2026-07-20-bbc-researchers-studied-ai-layoffs-heres-their-warning|Tsoukalas & Falk, July 2026]])

Every other source on this page describes what firms *are* doing (reshape-over-replace, hourglass organizations, continued junior hiring) or what firms *should* do (redesign work, not just cut cost). **Professor Gerry Tsoukalas** (with co-author **Brett Falk**), interviewed by Katty Kay for BBC's *New Normal*, supplies something the page previously lacked: a **formal mechanism for why competitive pressure could push firms toward mass AI-driven layoffs even when doing so is collectively self-defeating** — a genuinely different kind of claim from the rest of this page's largely descriptive/survey-based material.
