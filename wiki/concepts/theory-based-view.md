...
relationships:
  - type: supports
    target: strategy
    via: "TBV asks executives to articulate a firm-specific *theory of value* — the same construct Martin names as a *theory of winning*. The wiki holds them as decreasing-abstraction layers: TBV is the falsifiability discipline applied to Martin's *the theory must be coherent, doable, translatable into actions*"
  - type: supports
    target: analogical-reasoning
    via: "[[2026-04-28-carroll-sorensen-strategy-analogy|Carroll & Sørensen 2024]] position disciplined analogy as the practical methodology for TBV theory-discovery — analogies aid theory discovery, wider-team engagement, identifying unique aspects, and communication"
  - type: supports
    target: infinite-game
    via: "TBV's *novel / simple / elegant / falsifiable / generative* theory criteria are the falsifiability hygiene applied to Sinek's *Just Cause* — same construct at greater logical hygiene"
quality_score: 1
---
...
## Working definition (Felin & Zenger 2009, 2017, as cited in [[2026-04-28-carroll-sorensen-strategy-analogy|Carroll & Sørensen 2024]])
...
The wiki currently anchors TBV via second-hand citation in [[2026-04-28-carroll-sorensen-strategy-analogy|Carroll & Sørensen 2024]]. The two primary sources — Felin & Zenger 2009 *Strategy, Theory, and Practice* and Felin & Zenger 2017 *The Theory-Based View* — are deferred-ingest targets (see Open questions).
...
- **[[strategy|Martin's theory of winning]] ([[2022-06-29-martin-hbr-a-plan-is-not-a-strategy|Martin 2022]])** — Martin's *coherent, doable, translatable* tests are TBV's *novel / simple / elegant* tests in less rigorous vocabulary. TBV adds the **falsifiability** criterion explicitly; Martin implies it through *"what would have to be true"*. The two converge on the same construct from different traditions (Martin's practitioner-strategy literature; Felin & Zenger's academic-organisational-theory literature).
- **[[infinite-game|Sinek's Just Cause]] ([[2018-05-31-sinek-nyt-the-infinite-game|Sinek 2018]])** — TBV is the *logical hygiene* applied to the Just Cause. A Just Cause that fails TBV's falsifiability test is rhetorical, not strategic; a Just Cause that passes is a *theory of why this institution should perpetuate itself*.
- **[[strategy|Oberholzer-Gee's value stick]] ([[2022-02-23-oberholzer-gee-hbr-what-is-strategy-value-stick|Oberholzer-Gee 2022]])** — The value stick is the *measurement instrument* for TBV's *theory of value*. WTP/WTS asks *did the theory in fact create value?*; TBV asks *what theory predicts the value creation in the first place?*
- **[[analogical-reasoning|disciplined analogy]] ([[2026-04-28-carroll-sorensen-strategy-analogy|Carroll & Sørensen 2024]])** — Disciplined analogy is the **practical methodology** for TBV theory discovery: analogies surface candidate causal mechanisms, name what is unique about the firm, and communicate the theory to the must-convince audience. The Tripadvisor → Glassdoor worked example in the [[analogical-reasoning]] page is a TBV theory-discovery exercise in disguise.
- **[[strategic-foresight|strategic-foresight]]** — Foresight's scenarios are inputs to TBV's *what would have to be true* logic; TBV's theory is the synthesis foresight scenarios cannot supply on their own.
...
LIST
FROM "wiki/sources"
WHERE contains(file.outlinks, this.file.link) OR contains(tags, "theory-based-view") OR contains(tags, "tbv")
SORT file.name ASC
```
