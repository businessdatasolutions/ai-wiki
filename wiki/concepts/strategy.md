...
relationships:
  - type: supports
    ...
    via: "strategy and strategic foresight together cover the where-to-play / how-to-win / how-the-future-might-shape-both questions; Martin's *strategy as journey* and the *what-would-have-to-be-true* logic are foresight-adjacent"
  - type: supports
...
Per [[2022-02-23-oberholzer-gee-hbr-what-is-strategy-value-stick|Oberholzer-Gee 2022]]:
...
### Planning ≠ strategy ([[2022-06-29-martin-hbr-a-plan-is-not-a-strategy|Martin 2022]])
...
### The value stick ([[2022-02-23-oberholzer-gee-hbr-what-is-strategy-value-stick|Oberholzer-Gee 2022]])

A vertical bar from **WTP** (top) to **WTS** (bottom). Three wedges:

| Wedge | Formula | Beneficiary |
|---|---|---|
| **Customer delight** | WTP − price | Customers |
| **Firm margin** | price − cost-of-supply | The company |
| **Employee / supplier value** | compensation − WTS | Employees / suppliers |
...
#### Southwest Airlines ([[2022-06-29-martin-hbr-a-plan-is-not-a-strategy|Martin 2022]])
...
| Choice | Why it fit the theory |
|---|---|
| **Point-to-point** routes | *"You only make money when you're in the air"* — no idle ground time |
| **737-only fleet** | One type → simplified gates, systems, training, simulations |
| **No meals** | Short flights — saves cost and time |
...
#### Best Buy turnaround ([[2022-02-23-oberholzer-gee-hbr-what-is-strategy-value-stick|Oberholzer-Gee 2022]])

≈$1B quarterly loss → 20%+ ROIC, via two value-stick moves under a new CEO:

| Move | Value-stick effect |
|---|---|
...
### Three practices for escaping the planning trap ([[2022-06-29-martin-hbr-a-plan-is-not-a-strategy|Martin 2022]])
...
[[2026-03-31-carrier-mit-industrial-ai-that-works-strategy-survival-success|Carrier 2026]] (Senior Lecturer in System Dynamics, MIT Sloan) supplies the **2026 industrial-AI restatement** of the strategy vs planning distinction:
...
LIST
FROM "wiki/sources"
WHERE contains(file.outlinks, this.file.link) OR contains(tags, "strategy")
SORT file.name ASC
```
