...
### The arena-creation potion + arenas radar ([[2026-03-25-russell-bradley-mgi-race-takes-off-next-big-arenas|MGI 2026]])
...
1. A **technology or business-model step change** (transformer models in 2022; GLP-1 receptor agonists; vertical integration of EVs).
2. An **escalatory investment pattern** (capital outlays climbing faster than revenue; arms-race dynamics across multiple competitors).
3. A **large or expanding addressable market** (one with room to absorb the investment at global scale).
...
### Bridge: FTSG's process lens + MGI's outcome lens ([[2026-04-28-ftsg-convergence-outlook-2026|FTSG 2026]] ↔ [[2026-03-25-russell-bradley-mgi-race-takes-off-next-big-arenas|MGI 2026]])
