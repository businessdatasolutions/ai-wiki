...
### Redesigning-internal-structures + rapid-prototyping at a resource-constrained nonprofit ([[2026-07-14-khan-academy-ceo-the-real-ai-opportunity-is-in-boring-industries-sal-khan|Khan / Silicon Valley Girl, July 2026]])
...
The second 2026-08-12 batch tagged five of seven video sources against the [[warner-wager-process-model|W&W]] vocabulary; two — [[2026-07-13-haghighi-stanford-cs547-toward-ontological-multiplicity-in-ai|Haghighi's CS547 seminar]] and [[2026-08-03-chowdhery-mirhoseini-stanford-cs329a-self-improving-agents-part-1|the CS329A lecture]] — were **deliberately left untagged** as design-research and LLM-internals material respectively, per the page's when-not-to-tag guidance. Worth recording that the omissions are as deliberate as the tags: a corpus in which everything gets tagged would make the field useless as a filter.

**`contextual/external-triggers`** is the batch's most-instantiated cell and, unusually, from three quite different directions. [[2026-07-29-ng-washington-post-china-open-source-ai-competitiveness|Ng]]: lobbying against open weights, data-centre moratoriums, and price-sensitive non-US markets defaulting to Chinese open models — external forces reshaping what American firms can build on. [[2026-07-30-hines-pierce-mckinsey-ai-physical-world-more-valuable|Hines-Pierce]]: a 6.5-million-unit global housing shortfall, an AI-driven energy supercycle, **$1.5tn of funded projects stuck in permitting**, and a skilled-trades shortage with no near-term supply response — external constraints that bind regardless of a firm's own capability. And [[2026-08-05-frey-bloomberg-trumponomics-why-ai-isnt-boosting-productivity|Frey]]: restrictions on foreign use of frontier models converting model dependence into strategic exposure. Held together these describe a period in which the binding constraints on digital strategy are increasingly *outside* the firm — political, physical and demographic rather than technological.
