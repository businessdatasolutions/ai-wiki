...
| [[2026-06-19-chou-yc-lightcone-40-year-old-solo-founder\|Chou / YC Lightcone 2026]] | **The "anti-slop" opinionated-vibe-coding-platform anchor + domain-expert audience.** Bryant Chou (Webflow → Ploy) builds vibe-coded *award-winning* sites but explicitly frames Ploy as the *anti-slop* counter to generic vibe-coding output: a **deterministic "design slurper"** that extracts a consistent design system from an existing site (no 10 header-font variants) plus a curated **lookbook of ~3,500 web-design prompts** that gives the model *inspiration, not copies* — "if it was AI slop, that wouldn't have worked." The **Andy-Warhol-factory** framing (models are "the factories for human creativity") and the *"you need an opinion about how websites should be made"* line make the floor-vs-[[agentic-engineering\|ceiling]] split concrete *inside a vibe-coding product*: the platform supplies opinionated discipline so non-experts clear the quality bar. Extends the Replit/Emergent *domain-expert audience* claim and pairs the vibe-coding floor-raising thesis with the [[durable-skills\|taste/expertise]] differentiator |
